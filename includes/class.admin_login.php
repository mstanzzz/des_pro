...
class AdminLogin {
	...
	function __construct()
	{
		...
		if(strpos($_SERVER['REQUEST_URI'], 'solvitware/' )){ 
			$_SESSION['root'] = $_SERVER['DOCUMENT_ROOT'].'/solvitware';
		}elseif(strpos($_SERVER['REQUEST_URI'], 'designitpro' )){  
			$_SESSION['root'] = $_SERVER['DOCUMENT_ROOT'].'/designitpro'; 
		}elseif(strpos($_SERVER['REQUEST_URI'], 'storittek/' )){  
			$_SESSION['root'] = $_SERVER['DOCUMENT_ROOT'].'/storittek'; 
		}else{
	...
	function login($dbCustom,$user_name,$password) {
		if(!is_object($dbCustom)){			
			require_once($_SESSION['root']."/includes/class.dbcustom.php");
