...
?>
	...
	<div class="col-12 col-lg-6 col-xl-3">
		<div class="first-footer__wrapper">
			...
			<li><a href="<?php echo SITEROOT; ?>diy-instructions.html" title="Guide and Tips">DIY Instructions</a></li>
...
<div class="row second-footer">
	<div class="col-12">
		<div class="second-footer__wrapper">
			...
			<a href="<?php echo SITEROOT; ?>request-design.html" title="">Email A Closet Design</a>
