		...
		<body>
			<script type="text/javascript" language="javascript" src="<?php echo SITEROOT; ?>images/jquery-1.7.1.min.js"></script>
			<script type="text/javascript" src="<?php echo SITEROOT; ?>images/ZeroClipboard.js"></script>
			<script type="text/javascript" src="<?php echo SITEROOT; ?>images/sprintf.js"></script>
			...
			<!--
			<center><img src="<?php echo SITEROOT; ?>images/logo.png" alt="RapidLeech PlugMod" border="0" /></center><br />
			-->
