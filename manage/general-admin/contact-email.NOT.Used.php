...
<table cellpadding="10" cellspacing="0" border="0" width="100%">
	...
	<td>
	<a href="contact-email.php?sortby=name&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Name
	<br />
	<a href="contact-email.php?sortby=name&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
	</td>

	<td>
	<a href="contact-email.php?sortby=city&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	City/State
	<br />
	<a href="contact-email.php?sortby=city&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
	</td>

	<td width="25%">
	<a href="contact-email.php?sortby=last_update&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Date Submitted
	<br />
	<a href="contact-email.php?sortby=last_update&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
	</td>
