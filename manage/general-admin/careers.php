...
if(isset($_POST["del_careers_app_id"])){

	//if($user_level > 1){
		$careers_app_id = $_POST["del_careers_app_id"];
		$sql = sprintf("DELETE FROM careers_app_image WHERE careers_app_id = '%u'", $careers_app_id);
		$result = $dbCustom->getResult($db,$sql);
		$sql = sprintf("DELETE FROM careers_app WHERE careers_app_id = '%u'", $careers_app_id);
		$result = $dbCustom->getResult($db,$sql);
...
<div class="manage_page_container">
	...
	<div class="manage_main">
		...
		if($sortby != ''){
			...
			$sql .= " ORDER BY careers_app_id DESC".$limit;
		}
		$result = $dbCustom->getResult($db,$sql);		
...
<td>
	<div style="padding-top:47px;">
	<a href="careers.php?all=1" class="btn btn-primary btn-large">All</a>
	</div>
</td>
...
echo getPagination($total_rows, $rows_per_page, $pagenum, $truncate, $last, "careers.php", $sortby, $a_d, 0, 0,  $search_str,0,0,$strip);
echo "<br /><br /><br />";
}
?>	
...
<td width="20%">
	<a href="careers.php?sortby=name&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Name
	<br />
	<a href="careers.php?sortby=name&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
</td>
<td width="20%">
	<a href="careers.php?sortby=email&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	email
	<br />
	<a href="careers.php?sortby=email&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
</td>
<td width="10%">
	<a href="careers.php?sortby=last_update&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	last_update
	<br />
	<a href="careers.php?sortby=last_update&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
</td>

<td  width="40%">
	<a href="careers.php?sortby=department&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	department
	<br />
	<a href="careers.php?sortby=department&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
...
while($row = $result->fetch_object()) {
	...
	$block .= "<td valign='top'>".$row->department."</td>";
						
	$url_str = "view-careers-app.php";
	$url_str .= "?careers_app_id=".$row->careers_app_id;
	$url_str .= "&pagenum=".$pagenum;
	$url_str .= "&sortby=".$sortby;
	$url_str .= "&a_d=".$a_d;
	$url_str .= "&truncate=".$truncate;
	...
	<input type='hidden' id='".$row->careers_app_id."' class='itemId' 
	value='".$row->careers_app_id."' />DEL</a></td>";
	$block .= "</tr>";
}
echo $block;
?>
...
<div id="content-delete" class="confirm-content">
	...
	<form name="del_careers_app" action="<?php echo $url_str; ?>" method="post" target="_top">
		<input id="del_careers_app_id" class="itemId" type="hidden" name="del_careers_app_id" value='' />
		<a class="btn btn-large dismiss">No, Cancel</a>
		<button class="btn btn-danger btn-large" name="del_careers_app" type="submit" >Yes, Delete</button>
	</form>
</div>
