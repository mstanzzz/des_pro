...
$page_title = "Testimonials-Reviews";
$page_group = '';
$msg = '';
...
if(isset($_POST["add_testimonial"])){
	...
	if(file_exists($real_root."/user_uploads/")){
...
if(isset($_POST['set_active_and_display_order'])){
	...
	$is_featured_array = (isset($_POST['is_featured']))? $_POST['is_featured'] : array();
	...
	foreach($t_from_page_array as $t_id){
		if(is_numeric($t_id)){
			$sql = "UPDATE testimonial 
					SET hide = '1', is_local = '0', is_featured = '0' 
					WHERE testimonial_id = '".$t_id."'";
			$result = $dbCustom->getResult($db,$sql);				
		}
	}
	...
	foreach($is_featured_array as $key => $value){
		$sql = "UPDATE testimonial SET is_featured = '1' WHERE testimonial_id = '".$value."'";
		$result = $dbCustom->getResult($db,$sql);
		//echo "key: ".$key."   value: ".$value."<br />"; 
	}
...
<div class="manage_page_container">
	...
	<div class="manage_main">
		<?php 
echo "<center style='color:#df743a; font-size:26px;'>".$page_title."</center>";
echo "<br />";
$db = $dbCustom->getDbConnect(SITE_N_DATABASE);
...
<td>
<a href="testimonial-list.php?sortby=testimonial_id&a_d=a">
...
<td>
<a href="testimonial-list.php?sortby=name&a_d=a">
<img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
<br />
NAME
<br />
...
<td>
<a href="testimonial-list.php?sortby=city_state&a_d=a">
<img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
<br />
City/State
<br />
...
<td width="20%">
<a href="testimonial-list.php?sortby=last_update&a_d=a">
<img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
<br />
Date Submitted
<br />
...
<td width="10%">
<a href="testimonial-list.php?sortby=is_local&a_d=a">
<img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
<br />
Is Local
<br />
...
<td width="10%">
<a href="testimonial-list.php?sortby=is_featured&a_d=a">
<img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
<br />
Is Featured
<br />
<a href="testimonial-list.php?sortby=is_featured&a_d=d">
<img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>">
</a>
</td>

<td width="10%">
<a href="testimonial-list.php?sortby=hide&a_d=a">
<img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
Active
<a href="testimonial-list.php?sortby=hide&a_d=d">
<img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>
</td>
<td width="5%"><br />Edit<br /></td>
<td width="5%"><br />Del<br /></td>
</tr>
<?php
$t_from_this_page = '';
$block = ''; 
...
while($row = $result->fetch_object()) {
	...
	name='is_local[]' value='".$row->testimonial_id."' ".$checked." /></div>";
	$block	.= "</td>";
				
	$checked = ($row->is_featured == 1)? "checked='checked'" : ''; 
	$block	.= "<td>
	<div class='checkboxtoggle on ".$disabled." '> 
	<span class='ontext'>Yes</span>
	<a class='switch on' href='#'></a>
	<span class='offtext'>No</span>
	<input type='checkbox' class='checkboxinput' 
	name='is_featured[]' value='".$row->testimonial_id."' ".$checked." /></div>";
	$block	.= "</td>";
	...
	$block .= "<td>";
	$block .= "<a class='fancybox fancybox.iframe btn'"; 
