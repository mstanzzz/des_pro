...
<div class="manage_page_container">
	...
	<div class="manage_main">
		...
		if($all<1){
			if($search_str != ''){
				$sql .= " AND (name like '%".$search_str."%' OR subject like '%".$search_str."%' OR email like '%".$search_str."%' )" ;
			}
			if($date_from != ''){		
		...
		if($sortby != ''){
			...
			if($sortby == 'subject'){
				if($a_d == 'd'){
					$sql .= " ORDER BY subject DESC".$limit;
				}else{
					$sql .= " ORDER BY subject".$limit;		
				}
			}
		}else{
...
<td>
	<div style="padding-top:47px;">
	<a href="support.php?all=1" class="btn btn-primary btn-large">All</a>
	</div>
</td>
...
echo getPagination($total_rows, $rows_per_page, $pagenum, $truncate, $last, "support.php", $sortby, $a_d, 0, 0,  $search_str,0,0,$strip);
echo "<br /><br /><br />";
}
?>	
...
<td>
	<a href="support.php?sortby=name&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Name
	<br />
	<a href="support.php?sortby=name&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
</td>
<td width="25%">
	<a href="support.php?sortby=last_update&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	When Submitted
	<br />
	<a href="support.php?sortby=last_update&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
</td>
<td width="35%">
	<a href="support.php?sortby=subject&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Subject
	<br />
	<a href="support.php?sortby=subject&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
...
while($row = $result->fetch_object()) {
	...
	<input type='hidden' id='".$row->contact_email_id."' class='itemId' 
	value='".$row->contact_email_id."' />DEL</a></td>";
	$block .= "</tr>";
}
echo $block;
?>
