...
$this_page="design-request-list-done.php";
$strip = (isset($_GET['strip'])) ? $_GET['strip'] : 0;

$db = $dbCustom->getDbConnect(SITE_N_DATABASE);

if(isset($_POST['unset_done'])){
	$undone = (isset($_POST['undone']))? $_POST['undone'] : array();	
	print_r($undone);
	$sql = "UPDATE design_email SET done = '1' 
	WHERE profile_account_id = '".$_SESSION['profile_account_id']."'";
	$result = $dbCustom->getResult($db,$sql);
	foreach($undone as $key => $value){
		$sql = "UPDATE design_email SET done = '0' WHERE design_email_id = '".$value."'";
...
<a class="btn" href="design-request-list.php"> See Open Design Requests</a>	
...
$sql = "UPDATE design_email 
SET done='1'
WHERE date_submitted < '2459968318'"; 
//$n = $dbCustom->getResult($db,$sql);


$sql = "UPDATE design_email 
SET done='1'
WHERE design_email_id < '3000'"; 
//$n = $dbCustom->getResult($db,$sql);
...
<input type="hidden" name="unset_done" value="1">	
<input type="submit">	
<?php 
...
<td width="10%;">
	<a href="<?php echo $this_page; ?>?sortby=design_email_id&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	design_email_id
	<br />
	<a href="<?php echo $this_page; ?>?sortby=design_email_id&a_d=d">
	<img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
</td>
...
while($row = $result->fetch_object()){
	...
	$block .= date("Y", $row->date_submitted);
	$block .="<hr/>";	
	
	$block .=$row->date_submitted;

	$block .="</td>";	

	$block .= "<td>user_id:".$row->user_id."</td>";

	$block .= "<td>user_id:".$row->design_email_id."</td>";
	...
	$block .= "<td>";
	$block .= "<a class='btn btn-small' href='".$url_str."'>View / Print</a>";
	$block .= "</td>";
