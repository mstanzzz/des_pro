...
<script type="text/javascript" src="<?php echo SITEROOT; ?>manage/js/jquery.multiselect.min.js" ></script>
<script type="text/javascript" src="<?php echo SITEROOT; ?>manage/js/jquery.multiselect.filter.min.js"></script>
