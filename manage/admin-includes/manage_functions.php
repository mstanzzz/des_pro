...
function rename_cart_images_in_dirs($old_file_name, $new_file_name, $real_root, $domain=''){
	...
	if($old_file_name != '' && $new_file_name != ''){
		...
		$from 	= $real_root."/saascustuploads/".$_SESSION['profile_account_id']."/cart/".$old_file_name;
		$to 	= $real_root."/saascustuploads/".$_SESSION['profile_account_id']."/cart/".$new_file_name;	
		if(file_exists($from))rename($from , $to);
		...
		$from 	= $real_root."/saascustuploads/".$_SESSION['profile_account_id']."/cart/wide/".$old_file_name;
		$to 	= $real_root."/saascustuploads/".$_SESSION['profile_account_id']."/cart/wide/".$new_file_name;	
		if(file_exists($from))rename($from , $to);
		...
		$from 	= $real_root."/saascustuploads/".$_SESSION['profile_account_id']."/cart/exwide/".$old_file_name;
		$to 	= $real_root."/saascustuploads/".$_SESSION['profile_account_id']."/cart/exwide/".$new_file_name;	
		if(file_exists($from))rename($from , $to);
