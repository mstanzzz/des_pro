...
$cms_block .= "<a href='".SITEROOT."manage/cms/cms-landing.php'> CMS</a>";
$cms_block .= "<ul".multipleDirectories($cms_open,1).">";
$cms_block .= "<li><a href='".SITEROOT."manage/cms/pages/page.php'>Pages</a></li>";
$cms_block .= "<li><a href='".SITEROOT."manage/cms/custom-code/custom-code.php?firstload=1'>Meta tags</a></li>";                
...
$cat_block .= "<li><a href='".SITEROOT."manage/catalog/categories/t-category.php' >Categories</a></li>";
$cat_block .= "<li><a href='".SITEROOT."manage/catalog/products/item.php'>Products</a></li>";
$cat_block .= "<li><a href='".SITEROOT."manage/catalog/categories/document-list.php'>PDF List</a></li>";
$cat_block .= "<li><a href='".SITEROOT."manage/catalog/video/video-list.php' >Videos</a></li>";
$cat_block .= "<li><a href='".SITEROOT."manage/catalog/categories/svg-top-cat.php' >SVG List</a></li>";
$cat_block .= "<li><a href='".SITEROOT."manage/catalog/prod-sheet/index.php'>Product Sheet</a></li>";
$cat_block .= "<li><a href='".SITEROOT."manage/catalog/specs-feat/feats-list.php'>Product Features</a></li>";
$cat_block .= "<li><a href='".SITEROOT."manage/catalog/specs-feat/s-f-acces-list.php'>Product Accessories</a></li>";
$cat_block .= "<li><a href='".SITEROOT."manage/catalog/attributes/attribute.php'>Product Attributes</a></li>";
...
$ecom_block .= "> Ecommerce</a>";
$ecom_block .= "<ul ";            
$ecom_block .=multipleDirectories($ecom_open,1);
$ecom_block .=">";
$ecom_block .="<li><a href='".SITEROOT."manage/ecomsettings/global-discount.php'>Discount</a></li>";
...
$ecom_block .="<li><a href='".SITEROOT."manage/ecomsettings/ship-carrier.php'>Shipping</a></li>";				
$ecom_block .="<li><a href='".SITEROOT."manage/ecomsettings/payment-processor.php'>Pay</a></li>";
$ecom_block .="</ul>";
$ecom_block .="</li>";
...
$cust_block .= ">Customers</a>";
$cust_block .= "<ul "; 
$cust_block .= multipleDirectories($custord_open,1);
$cust_block .= ">";

$cust_block .= "<li><a href='".SITEROOT."manage/general-admin/testimonial-list.php'>Reviews</a></li>";

$cust_block .= "<li><a href='".SITEROOT."manage/design/design-request-list.php'>Design Requests</a></li>";

$cust_block .= "<li><a href='".SITEROOT."manage/customer/customer-list.php'>Customers</a></li>";

$cust_block .= "<li><a href='".SITEROOT."manage/general-admin/support.php'>Support</a></li>";

$cust_block .= "<li><a href='".SITEROOT."manage/general-admin/careers.php'>Careers</a></li>";

$cust_block .= "<li><a href='".SITEROOT."manage/general-admin/for-pros.php'>For the Pros</a></li>";   

$cust_block .= "<li><a href='".SITEROOT."manage/general-admin/in-home-consult.php'>In home consult</a></li>";   
...
$cust_block .= "<li><a href='".SITEROOT."manage/order-management/master/transaction-list.php'>Transaction</a></li>";
$cust_block .= "<li><a href='".SITEROOT."manage/order-management/master/failed-order-list.php'>Failed Orders</a></li>";
$cust_block .= "<li><a href='".SITEROOT."manage/order-management/process-definition.php'>Processes</a></li>";            
$cust_block .= "<li><a href='".SITEROOT."manage/customer/edit-review-email.php'>Review Text</a></li>";            
...
$adm_block .= "</span>";
$adm_block .= "<a href='".SITEROOT."manage/general-admin/admin-landing.php'>Admin</a>";
$adm_block .= " <ul ";
...
$adm_block .= "<li><a href='".SITEROOT."manage/general-admin/add-on-change-request.php'>Add-ons</a></li>";
...
$adm_block .= "<li><a href='".SITEROOT."manage/general-admin/states.php'>Location</a></li>";			
$adm_block .= "</ul>";
$adm_block .= "</li>";
...
$mast_block .= ">Master Admin</a>";
$mast_block .= "<ul ";
$mast_block .= multipleDirectories($master_admin_open,1);
$mast_block .= ">";   
$mast_block .= "<li><a href='".SITEROOT."manage/master-admin/sas-cust.php'>SaaS</a></li>";
...
$des_block .= multipleDirectories($design_open,1);
$des_block .= ">";   
$des_block .= "<li><a href='".SITEROOT."manage/design/design-email.php'>Requests</a></li>";
$des_block .= "<li><a href='".SITEROOT."manage/design/in-home-consult.php'>Consult</a></li>";
$des_block .= "<li><a href='".SITEROOT."manage/design/design-req-origin-stats.php'>Statistics</a></li>";
$des_block .= "</ul>";
$des_block .= "</li>";
