...
<div class="manage_page_container">
	...
	while($row = $result->fetch_object()) {
			...
			if($img_res->num_rows > 0){
				...
				$block .= "<a class='fancybox' href='".SITEROOT."/saascustuploads/".$_SESSION['profile_account_id']."/cart/".$img_object->file_name."'>";
			...
			************************************************************************>>$url_str= "edit-item.php";
			...
			while($child_row = $child_res->fetch_object()) {
				...
				if($img_res->num_rows > 0){
					...
					href='".SITEROOT."/saascustuploads/".$_SESSION['profile_account_id']."/cart/".$img_object->file_name."'>";
					$block .= "<img  src='".SITEROOT."/saascustuploads/".$_SESSION['profile_account_id']."/cart/thumb/".$img_object->file_name."'></a>";
				}else{
					$block .= "<td colspan='3'>";
				}
