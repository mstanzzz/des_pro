...
if(isset($_POST['set_active'])){
	...
	$show_is_srs = (isset($_POST['show_is_sr']))? $_POST['show_is_sr'] : array();
...
$block .= "</td>";	
	...
	$block	.= "<td align='center' valign='middle' >
		...
		<a class='switch on' href='#'></a>
		<span class='offtext'>OFF</span>
		<input type='checkbox' class='checkboxinput' name='show_is_sr[]' value='".$row->item_id."' ".$checked." /></div></td>";	
