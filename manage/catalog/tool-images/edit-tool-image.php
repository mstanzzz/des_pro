...
$tool_image_id = (isset($_GET['tool_image_id'])) ? $_GET['tool_image_id'] : 0;
if(!isset($_SESSION['tool_image_id'])) $_SESSION['tool_image_id'] = $tool_image_id;

$sql = sprintf("SELECT * FROM tool_image WHERE tool_image_id = '%u'", $_SESSION['tool_image_id']);
...
<input type="hidden" name="update_tool_image" value="1">
<input type="hidden" name="tool_image_id" value="<?php echo $_SESSION['tool_image_id']; ?>">
...
<td>
<input type="text" name="title" value="<?php echo $_SESSION['temp_fields']['title']; ?>" style="width:80%;" />
</td>
</tr>
</table> 
</form>
