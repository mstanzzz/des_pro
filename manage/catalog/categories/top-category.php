...
if(isset($_POST['del_cat_id'])){
	...
	if($result->num_rows > 0){	
		...
		if($res->num_rows > 0){	
			...
			$p = $_SERVER['DOCUMENT_ROOT']."/saascustuploads/".$_SESSION['profile_account_id']."/cart/".$file_name;
...
foreach($top_cats as $top_cat) {
	...
	$block .= "<a class='fancybox' href='".SITEROOT."saascustuploads/".$_SESSION['profile_account_id']."/cart/".$top_cat['file_name']."'>";
