...
function bindfocus(){
	$('.tree li a').focus(function(){
		...
		editbtn = '<a href="edit-t-category.php?cat_id='+catid+'&ret_page=category-tree&firstload=1&strip=1" class="btn btn-primary fancybox fancybox.iframe"><i class="icon-cog icon-white"></i> Edit</a>';
...
<div class="manage_page_container <?php if($strip){ echo 'lightbox'; }?>">
	...
	<div class="page_actions cancelscroll">
		...
		href="add-t-category.php?ret_page=top&firstload=1&strip=1">
...
$block .= "<a tabindex='-1' class='tree-parent' onclick='show_children(".$t_cat['cat_id'].")'"; 
$block .= "data-imageurl='".SITEROOT."/saascustuploads/".$_SESSION['profile_account_id']."/cart/small/".$t_cat['file_name']."'"; 
$block .= "data-catid='".$t_cat['cat_id']."' data-cattype='topcat'>".stripslashes($t_cat['name'])."</a>";
