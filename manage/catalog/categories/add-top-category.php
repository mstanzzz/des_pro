...
if(!isset($_SESSION['temp_fields']['showroom_item_display_priority'])) $_SESSION['temp_fields']['showroom_item_display_priority'] = 1;
...
<input style="width:600px;" type="text" id="img_alt_text" name="img_alt_text" value="<?php echo stripslashes($_SESSION['temp_fields']['img_alt_text']); ?>"/>
</div>            
</fieldset>
<fieldset>
...
<input style="width:600px;" name="name" type="text" value="<?php echo stripslashes($_SESSION['temp_fields']['name']); ?>" />
</div>
<div class="colcontainer">
<label>Short name for website navigation</label>
<input style="width:230px;" type="text" id="short_name" name="short_name" value="<?php echo stripslashes($_SESSION['temp_fields']['short_name']); ?>"/>
</div>
<div class="colcontainer">
<label>Tool tip</label>

<input style="width:600px;" name="name" type="text" value="<?php echo stripslashes($_SESSION['temp_fields']['tool_tip']); ?>" /></div>
<div class="colcontainer">
<label>Key Words</label>
<input style="width:600px;" name="key_words" type="text" value="<?php echo stripslashes($_SESSION['temp_fields']['key_words']); ?>" />
</div>
<div class="colcontainer">
<label>Description</label>
<textarea rows="25" name="description"><?php echo stripslashes($_SESSION['temp_fields']['description']); ?></textarea>
</div>
</fieldset>
