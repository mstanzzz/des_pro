		...
		<div class="colcontainer">              
			...
			<fieldset>
				...
				<div class="colcontainer formcols">
					...
					<input style="width:230px;" type="text" name="short_name" value="<?php echo stripslashes($_SESSION['temp_fields']['short_name']); ?>" />
				</div>
				<div class="colcontainer formcols">
					<label>Tool Tip</label>
					<input style="width:600px;" name="tool_tip" type="text" value="<?php echo stripslashes($_SESSION['temp_fields']['tool_tip']); ?>" />	
				</div>
				<div class="colcontainer">
				...
				<div class="colcontainer formcols">
					...
					<textarea name="description" rows="25" /><?php echo stripslashes($_SESSION['temp_fields']['description']); ?></textarea>
				</div>
