        ...
        <tr>
			...
			<div style='float:left;  width:400px;'>	
				...
				echo "
					...
					<a class='inline' href='".SITEROOT."/ul_cart/".$domain."/cart/".$file_name."'>
					<img src='".SITEROOT."/ul_cart/".$domain."/cart/list/".$file_name."'>			
            		</a>";
...
<?php
    ...
    while($img_row = $img_res->fetch_object()) {
        ...
        $block .= "<img src='".SITEROOT."/ul_cart/".$domain."/cart/list/".$img_row->file_name."'   />";
...
<?php
    ...
    while($doc_row = mysql_fetch_object($doc_result)) {
    	$block = ''; 
        $block .= "<div>";
        $block .= "<a href='".SITEROOT."/ul_cart/".$domain."/media/".$doc_row->name."' >$doc_row->name</a>";
