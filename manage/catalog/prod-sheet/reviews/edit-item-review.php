      ...
      <input type="hidden" name="item_id" value="<?php echo $item_id;  ?>" />
			...
			<div class="page_actions edit_page">
				<?php if($admin_access->product_catalog_level > 1){ ?>  
	                <button type="submit" class="btn btn-success btn-large" name="edit_item_review">
					Save Review </button>
				 <?php }else{ ?>
                    <div class="alert">Sorry, you don't have the permissions to edit this item.</div>
                <?php } ?>
                <hr />
				<a href="<?php echo $url_str; ?>" class="btn">Cancel &amp; Go Back</a> 
			</div>
			<div class="edit_page">
				<fieldset>
