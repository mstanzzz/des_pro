...
<a href="t-category.php?sortby=name&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>	
	...
	<td width="16%;">
<a href="t-category.php?sortby=rating&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Rating
	<br />
<a href="t-category.php?sortby=rating&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>	
	</td>

	<td width="16%;">
<a href="t-category.php?sortby=publish_date&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Date
	<br />
<a href="t-category.php?sortby=publish_date&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>	
	</td>

	<td width="16%;">
<a href="t-category.php?sortby=item_name&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Product
	<br />
<a href="t-category.php?sortby=item_name&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>	
	</td>
	<td><br />Edit<br /></td>
	<td><br />Active<br /></td>
	<td><br />Delete<br /></td>
