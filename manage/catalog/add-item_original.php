...
$_SESSION['temp_fields']["parent_item_id"] = $parent_item_id;
...
if(isset($_POST["add_keyword"])){
	...
	//echo "----------".$_SESSION['temp_fields']["price_flat"];
...
if($_SESSION["copied"] == 0){
	...
	if(!isset($_SESSION['temp_fields']["call_for_pricing"])) $_SESSION['temp_fields']["call_for_pricing"] = '';	
	if(!isset($_SESSION['temp_fields']["is_new_product"])) $_SESSION['temp_fields']["is_new_product"] = '';	
	if(!isset($_SESSION['temp_fields']["is_promo_product"])) $_SESSION['temp_fields']["is_promo_product"] = '';	
	if(!isset($_SESSION['temp_fields']["allow_back_order"])) $_SESSION['temp_fields']["allow_back_order"] = '';	
	if(!isset($_SESSION['temp_fields']["manufacturer_id"])) $_SESSION['temp_fields']["manufacturer_id"] = '';	
	//if(!isset($_SESSION['temp_fields']["style_id"])) $_SESSION['temp_fields']["style_id"] = '';	
	if(!isset($_SESSION['temp_fields']["is_taxable"])) $_SESSION['temp_fields']["is_taxable"] = '';	
	if(!isset($_SESSION['temp_fields']["prod_number"])) $_SESSION['temp_fields']["prod_number"] = '';	
	if(!isset($_SESSION['temp_fields']["vend_man_id"])) $_SESSION['temp_fields']["vend_man_id"] = '';
	if(!isset($_SESSION['temp_fields']["brand_id"])) $_SESSION['temp_fields']["brand_id"] = '';
	
		
	if(!isset($_SESSION['temp_fields']["sku"])) $_SESSION['temp_fields']["sku"] = '';	
	if(!isset($_SESSION['temp_fields']["upc"])) $_SESSION['temp_fields']["upc"] = '';	
	...
	//if(!isset($_SESSION['temp_fields']["type_id"])) $_SESSION['temp_fields']["type_id"] = '';	
	//if(!isset($_SESSION['temp_fields']["lead_time_id"])) $_SESSION['temp_fields']["lead_time_id"] = '';	
	//if(!isset($_SESSION['temp_fields']["skill_level_id"])) $_SESSION['temp_fields']["skill_level_id"] = '';	
	if(!isset($_SESSION['temp_fields']["ship_port_id"])) $_SESSION['temp_fields']["ship_port_id"] = '';	
	if(!isset($_SESSION['temp_fields']["return_to_id"])) $_SESSION['temp_fields']["return_to_id"] = '';	
	if(!isset($_SESSION['temp_fields']["is_drop_shipped"])) $_SESSION['temp_fields']["is_drop_shipped"] = '';	
	if(!isset($_SESSION['temp_fields']['img_id'])) $_SESSION['temp_fields']['img_id'] = '';	

	if(!isset($_SESSION['temp_fields']["is_closet"])) $_SESSION['temp_fields']["is_closet"] = 0;	
	if(!isset($_SESSION['temp_fields']['show_in_cart'])) $_SESSION['temp_fields']['show_in_cart'] = 1;	
	...
	if(!isset($_SESSION['temp_fields']["weight"])) $_SESSION['temp_fields']["weight"] = '';	
	...
	while($attr_row = mysql_fetch_object($attr_res)) {
		if(!isset($_SESSION['temp_fields']["attr_".$attr_row->attribute_id])) $_SESSION['temp_fields']["attr_".$attr_row->attribute_id] = 0;
		$is_attributes = 1;
	}
    ...
    <form name="add_item" action="item.php?cat_id=<?php echo $cat_id; ?>" method="post"  
        ...
        -->
   		<tr>
            ...
            <input type="text" name="name" value="<?php echo $_SESSION['temp_fields']['name']; ?>" maxlength="100" style="width:300px" />
		...
		<tr>
			...
			?>	
				...
				if(!isset($_SESSION['temp_fields']["date_inactive"])){	
					...
					$v_date = $_SESSION['temp_fields']["date_inactive"]; 
				}
				?>
...
<br /><br />
     ...
     <table border="0" cellpadding="10" width="100%">
  		...
  		<tr>
            ...
            <input type="radio" name="show_in_cart" value="1" <?php if($_SESSION['temp_fields']['show_in_cart'] == 1) echo "checked";?>/> <span>yes</span>
            </div>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="show_in_cart" value="0" <?php if($_SESSION['temp_fields']['show_in_cart'] == 0) echo "checked";?>/> <span>no</span>
			</div>            
            </td>
		</tr>
  		...
  		<tr>
			...
			<td>
            <div style="float:left; padding-left:46px;">	            
            <input id="in_shrm" onchange="setIsCloset()" type="radio" name="show_in_showroom" value="1" <?php if($_SESSION['temp_fields']['show_in_showroom'] == 1) echo "checked";?>/> <span>yes</span>
            </div>
            <div style="float:left; padding-left:46px;">	            
            <input id="not_in_shrm" onchange="setNotCloset()" type="radio" name="show_in_showroom" value="0" <?php if($_SESSION['temp_fields']['show_in_showroom'] == 0) echo "checked";?>/> <span>no</span>
			</div>            
            </td>
		</tr>
  		...
  		<tr>
			...
			<td>
            <div style="float:left; padding-left:46px;">	            
            <input id="is_clst" type="radio" name="is_closet" value="1" <?php if($_SESSION['temp_fields']["is_closet"] == 1) echo "checked";?>/> <span>yes</span>
            </div>
            <div style="float:left; padding-left:46px;">	            
            <input id="is_not_clst" type="radio" name="is_closet" value="0" <?php if($_SESSION['temp_fields']["is_closet"] == 0) echo "checked";?>/> <span>no</span>
			</div>            
            </td>
		</tr>
...
<br /><br />
	...
	while($attr_row = mysql_fetch_object($attr_res)) {
		...
		if($res->num_rows > 0){
			...
			//$block .= $_SESSION['temp_fields']["attr_".$attr_row->attribute_id];
			...
			while($opt_row = $res->fetch_object()) {
				...
				if($_SESSION['temp_fields']["attr_".$attr_row->attribute_id] == $opt_row->opt_id){
					$sel = "selected";	
				}else{
					$sel = '';	
				}
...
<br /><br />
    ...
    <table border="0" cellpadding="10" width="100%">
  		<tr>
			...
			<td>	            
            $<input type="text" name="price_flat" value="<?php echo $_SESSION['temp_fields']["price_flat"]; ?>" maxlength="10" style="width:50px" onblur="checkNum(this)" />
            (<i>numbers only</i>)
            </td>
		</tr>
  		<tr>
			...
			<td>	            
            $<input type="text" name="price_wholesale" value="<?php echo $_SESSION['temp_fields']["price_wholesale"]; ?>" maxlength="10" style="width:50px" onblur="checkNum(this)" />
            (<i>numbers only</i>)
            </td>
		</tr>
  		<tr>
			...
			<td>	            
            %<input type="text" name="percent_markup" value="<?php echo $_SESSION['temp_fields']["percent_markup"]; ?>" maxlength="10" style="width:50px" onblur="checkPercent(this)" />
            (<i>numbers only</i>)
            </td>
		</tr>
  		<tr>
			...
			<td>	            
            %<input type="text" name="percent_off" value="<?php echo $_SESSION['temp_fields']["percent_off"]; ?>" maxlength="10" style="width:40px" onblur="checkPercent(this)" />
            (<i>numbers only</i>)
            </td>
		</tr>
  		<tr>
			...
			<td>	            
            $<input type="text" name="amount_off" value="<?php echo $_SESSION['temp_fields']["amount_off"]; ?>" maxlength="10" style="width:40px" onblur="checkNum(this)" />
            (<i>numbers only</i>)
            </td>
		</tr>
  		...
  		<tr>
			...
			<td>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="is_taxable" value="1" <?php if($_SESSION['temp_fields']["is_taxable"] == 1) echo "checked";?>/> <span>yes</span>
            </div>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="is_taxable" value="0" <?php if($_SESSION['temp_fields']["is_taxable"] == 0) echo "checked";?>/> <span>no</span>
			</div>            
            </td>
		</tr>
  		<tr>
			...
			<td>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="call_for_pricing" value="1" <?php if($_SESSION['temp_fields']["call_for_pricing"] == 1) echo "checked";?>/> <span>yes</span>
            </div>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="call_for_pricing" value="0" <?php if($_SESSION['temp_fields']["call_for_pricing"] == 0) echo "checked";?> /> <span>no</span>
			</div>            
            </td>
		</tr>
    ...
    <fieldset>
     ...
     <table border="0" cellpadding="10" width="100%">
  		...
  		<tr>
			...
			<td>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="is_new_product" value="1" <?php if($_SESSION['temp_fields']["is_new_product"] == 1) echo "checked";?>/> <span>yes</span>
            </div>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="is_new_product" value="0" <?php if($_SESSION['temp_fields']["is_new_product"] == 0) echo "checked";?>/> <span>no</span>
			</div>            
            </td>
		</tr>
  		...
  		<tr>
			...
			<td>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="is_promo_product" value="1" <?php if($_SESSION['temp_fields']["is_promo_product"] == 1) echo "checked";?>/> <span>yes</span>
            </div>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="is_promo_product" value="0" <?php if($_SESSION['temp_fields']["is_promo_product"] == 0) echo "checked";?>/> <span>no</span>
			</div>            
            </td>
		</tr>
  		...
  		<tr>
			...
			<td>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="allow_back_order" value="1" <?php if($_SESSION['temp_fields']["is_promo_product"] == 1) echo "checked";?>/> <span>yes</span>
            </div>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="allow_back_order" value="0" <?php if($_SESSION['temp_fields']["is_promo_product"] == 0) echo "checked";?>/> <span>no</span>
			</div>            
            </td>
		</tr>
        ...
        <!--
  		...
  		<tr>
			...
			<td>	            
            <input type="text" name="finish" value="<?php//echo $_SESSION['temp_fields']["finish"]; ?>" maxlength="100" style="width:300px" />
            </td>
		</tr>
        <tr>
        	<td>
			...
			<td>	            
            <input type="text" name="color" value="<?php//echo $_SESSION['temp_fields']["color"]; ?>" maxlength="100" style="width:300px" />
            </td>
		</tr>
  		...
  		<tr>
			...
			<td>	            
            <input type="text" name="height" value="<?php//echo $_SESSION['temp_fields']["height"]; ?>" style="width:40px" onblur="checkNum(this)" />
            </td>
		</tr>
  		<tr>
        	<td>
			...
			<td>	            
            <input type="text" name="width" value="<?php//echo $_SESSION['temp_fields']["width"]; ?>" style="width:40px" onblur="checkNum(this)" />
            </td>
		</tr>
        -->
  		...
  		<tr>
			...
			<td>	            
            <input type="text" name="prod_number" value="<?php echo $_SESSION['temp_fields']["prod_number"]; ?>" maxlength="100" style="width:300px" />
            </td>
		</tr>
  		<tr>
        	<td>
			...
			<td>	            
            <input type="text" name="sku" value="<?php echo $_SESSION['temp_fields']["sku"]; ?>" maxlength="100" style="width:300px" />
            </td>
		</tr>
  		<tr>
        	<td>
			...
			<td>	            
            <input type="text" name="upc" value="<?php echo $_SESSION['temp_fields']["upc"]; ?>" maxlength="100" style="width:300px" />
            </td>
		</tr>
		...
		<?php
               $block = "<select name='brand_id' class='form_select_small'>";
				...
				while($b_row = $res->fetch_object()) {
					$sel = ($b_row->brand_id == $_SESSION['temp_fields']["brand_id"])? "selected": ''; 
        ...
        <tr>
			...
			<td>	            
            <input type="text" name="weight" value="<?php echo $_SESSION['temp_fields']["weight"]; ?>" style="width:40px" onblur="checkNum(this)" />
            </td>
		</tr>
        ...
        <tr>
			...
			<td>	            
            <input type="text" name="shipping_flat_charge" value="<?php echo $_SESSION['temp_fields']["shipping_flat_charge"]; ?>" style="width:40px" onblur="checkNum(this)" />
            </td>
		</tr>
		...
		<?php
				...
				while($s_row = mysql_fetch_object($s_res)) {
					$sel = ($s_row->style_id == $_SESSION['temp_fields']["style_id"])? "selected": ''; 					
		...
		?>
  		...
  		<tr>
			...
			/*
				...
				$block .= "<option value='0'>none</option>";
				while($s_row = mysql_fetch_object($s_res)) {
					$sel = ($s_row->type_id == $_SESSION['temp_fields']["type_id"])? "selected": ''; 					
  		...
  		<tr>
			...
			/*
				...
				$block .= "<option value='0'>none</option>";
				while($s_row = mysql_fetch_object($s_res)) {
					$sel = ($s_row->lead_time_id == $_SESSION['temp_fields']["lead_time_id"])? "selected": ''; 					
        ...
        /*
				...
				$block .= "<option value='0'>none</option>";
				while($s_row = mysql_fetch_object($s_res)) {
					$sel = ($s_row->skill_level_id == $_SESSION['temp_fields']["skill_level_id"])? "selected": ''; 					
		...
		<?php
				...
				$block .= "<option value='0'>none</option>";
				while($s_row = mysql_fetch_object($s_res)) {
					$sel = ($s_row->return_to_id == $_SESSION['temp_fields']["return_to_id"])? "selected": ''; 					
		...
		<?php
				...
				$block .= "<option value='0'>none</option>";
				while($s_row = mysql_fetch_object($s_res)) {
					$sel = ($s_row->ship_port_id == $_SESSION['temp_fields']["ship_port_id"])? "selected": ''; 					
		...
		?>
  		...
  		<tr>
			...
			<td>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="is_drop_shipped" value="1" <?php if($_SESSION['temp_fields']["is_drop_shipped"] == 1) echo "checked";?>/> <span>yes</span>
            </div>
            <div style="float:left; padding-left:46px;">	            
            <input type="radio" name="is_drop_shipped" value="0" <?php if($_SESSION['temp_fields']["is_drop_shipped"] == 0) echo "checked";?>/> <span>no</span>
			</div>            
            </td>
		</tr>
     ...
     <table border="0" cellpadding="10" width="100%">
		...
		<div style="float:left; width:280px;">
			...
			/*
				...
				$block .= "<option value='0'>none</option>";
				while($s_row = mysql_fetch_object($s_res)) {
					$sel = ($s_row->item_id == $_SESSION['temp_fields']["parent_item_id"])? "selected": ''; 					
...
<br /><br />        
     ...
     <table border="0" cellpadding="10" width="100%">
        <tr>
	        ...
	        <textarea class="selector_1"  name="short_description" rows="2" cols="80" style="width: 450px" ><?php echo $_SESSION['temp_fields']["short_description"]; ?></textarea>
            </td>
        </tr>
        <tr>
			<td colspan="2">
	        ...
	        <textarea class="selector_2"  name="description" rows="4" cols="80" style="width: 450px"><?php echo $_SESSION['temp_fields']['description']; ?></textarea>
            </td>
        </tr>        
        <tr>
			<td colspan="2">
	        ...
	        <textarea  name="back_order_message" rows="2" cols="80" style="width: 450px" ><?php echo $_SESSION['temp_fields']["back_order_message"]; ?></textarea>
            </td>
        </tr>     
        <tr>
			<td colspan="2">
	        ...
	        <textarea  name="in_stock_message" rows="2" cols="80" style="width: 450px" ><?php echo $_SESSION['temp_fields']["in_stock_message"]; ?></textarea>
            </td>
        </tr>
        <tr>
			<td colspan="2">
	        ...
	        <textarea  name="additional_information" rows="2" cols="80" style="width: 450px"><?php echo $_SESSION['temp_fields']["additional_information"]; ?></textarea>
            </td>
        </tr>
