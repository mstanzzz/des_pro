...
if(!isset($_SESSION['temp_fields']['embed']))$_SESSION['temp_fields']['embed'] = '';
...
<button type="submit" name="add_video" class="btn btn-success">Submit </button>
