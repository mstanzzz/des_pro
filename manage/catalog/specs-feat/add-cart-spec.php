...
$url_str .= "?ret_page=add-cart-spec";
...
<a onClick="set_cat_session();" href="<?php echo $url_str; ?>" class="btn btn-info">Size 1 Image</a>
...
class="btn btn-info" href="<?php echo $url_str; ?>">Size 1 Image</a>
</td>
</tr>
