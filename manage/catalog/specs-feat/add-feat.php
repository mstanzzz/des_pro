...
if(!isset($_SESSION['temp_fields']['sub_title'])) $_SESSION['temp_fields']['sub_title'] = '';	
if(!isset($_SESSION['temp_fields']['sub_1_title'])) $_SESSION['temp_fields']['sub_1_title'] = '';	
if(!isset($_SESSION['temp_fields']['text'])) $_SESSION['temp_fields']['text'] = '';	
...
<form name="form1" action="<?php echo $url_str; ?>" method="post">
    <input type="hidden" name="add_feat" value="1">  
...
?>
<a onClick="set_feat_session();" class="btn btn-info" href="<?php echo $url_str; ?>">Select Image</a>
</td>
</tr>
...
foreach($_SESSION['feat_gallery'] as $val){
	...
	if($img_res->num_rows > 0){
		...
		echo "<td><a href='add-feat.php?delgalleryimgid=".$val."#img' class='btn btn-small btn-danger'></a></td>";
...
<input class="btn btn-primary" style="float:left; margin:30px; padding:10px;" type="submit" name="submit" value="Save">			
