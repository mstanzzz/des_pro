...
$sql = "SELECT * FROM s_f_acces WHERE s_f_acces_id = '".$_SESSION['s_f_acces_id']."'"; 
...
onSubmit="return validate(this)"  enctype="multipart/form-data"  target="<?php echo $target; ?>">
    ...
    <input type="hidden" name="update_s_f_acces" value="1">  
    <input type="hidden" name="s_f_acces_id" value="<?php echo $_SESSION['s_f_acces_id']; ?>">  
...
$url_str .= "?ret_page=edit-s-f-acces";
$url_str .= "&ret_path=catalog/specs-feat";
$url_str .= "&ret_dir=specs-feat";
$url_str .= "&s_f_acces_id=".$_SESSION['s_f_acces_id'];
