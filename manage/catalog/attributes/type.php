	...
	<div class="manage_main">
		...
		?>
			<div class="page_actions"> 
            	<a class="btn btn-large btn-primary confirm confirm-add" href="#">Add a New Type </a>
			</div>
		<?php 
		}
...
while($row = $result->fetch_object()) {
	...
	Edit<input type='hidden' class='itemId' id='".$row->type_id."' value='".$row->type_id."' />
	...
	<input type='hidden' id='".$row->type_id."' class='itemId' value='".$row->type_id."' />DEL</a></td>";
	$block .= "</tr>";
}
echo $block;
?>
