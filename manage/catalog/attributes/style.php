	...
	<div class="manage_main">
		...
		?>
			<div class="page_actions"> 
				<a class="btn btn-large btn-primary confirm confirm-add" href="#">Add a New Style </a>
			</div>
		<?php
		}
$db = $dbCustom->getDbConnect(CART_N_DATABASE);
...
<?php
	...
	while($row = $result->fetch_object()) {
		...
		<input type='hidden' id='".$row->style_id."' class='itemId' value='".$row->style_id."' />DEL</a></td>";		
		$block .= "</tr>";
