...
if(isset($_POST['become_child'])){
	...
	if($parent_item > 0){
		...
		if($result->num_rows > 0){
			...
			$_SESSION['temp_fields']['parent_item_id'] = $parent_item;
...
if($result->num_rows > 0){
	...
	if(!isset($_SESSION['temp_fields']['parent_item_id'])) $_SESSION['temp_fields']['parent_item_id'] = $object->parent_item_id;	

	if(!isset($_SESSION['temp_fields']['main_attr_id'])) $_SESSION['temp_fields']['main_attr_id'] = $object->main_attr_id;


	if(!isset($_SESSION['temp_fields']['name'])) $_SESSION['temp_fields']['name'] = $object->name;
	

	if(!isset($_SESSION['temp_fields']['is_kit'])) $_SESSION['temp_fields']['is_kit'] = $object->is_kit;	
...
<div class="manage_page_container lightbox">
	...
	<?php
		$page_title .= stripslashes($_SESSION['temp_fields']['name']);
		...
		<form id="edit_item_form" name="edit_item" action="edit-item-attributes.php" method="post"   enctype="multipart/form-data">
            ...
            <div class="page_actions edit_page"> 
				...
				if($admin_access->product_catalog_level > 1){ 
					...
					if($_SESSION['temp_fields']['parent_item_id'] == 0){
			...
			<div class="page_content edit_page">
				...
				<fieldset class="edit_images" id="product_images">
					<div class="colcontainer">
						...
						<?php
							echo stripslashes($_SESSION['temp_fields']['name']);
							echo "<br />";
