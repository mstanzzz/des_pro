...
/* 
				...
				$j =  $j +1;
					...
					$block .= "<td><a class='btn btn-primary confirm confirm-edit ".$disabled." '>Edit
					...
					<input type='hidden' id='".$row->skill_level_id."' class='itemId' value='".$row->skill_level_id."' />DEL</a></td>";
					$block .= "</tr>";
				}
				echo $block;
*/				
