...
if($_POST){
	...
	if($result->num_rows > 0){
		...
		$existing_common_path = $real_root."/saascustuploads/".$_SESSION['profile_account_id']."/cart/docs";
		...
		if($old_vend_man_id > 0){
			...
			if($result->num_rows > 0){
				...
				if($existing_file_name != ''){
					...
					$old_vm_path = $real_root."/saascustuploads/".$_SESSION['profile_account_id']."/cart/docs/".$oldvm_name;
	...
	if($existing_file_name != ''){
		...
		if($result->num_rows > 0){
			...
			$new_vm_path = $real_root."/saascustuploads/".$_SESSION['profile_account_id']."/cart/docs/".$newvm_name;
