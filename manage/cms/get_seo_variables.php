...
$_SESSION['temp_fields']['seo_name'] = $seo_name;
$_SESSION['temp_fields']['title'] = $title;
$_SESSION['temp_fields']['keywords'] = $keywords;
$_SESSION['temp_fields']['description'] = $description;
