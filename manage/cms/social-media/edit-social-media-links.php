...
<div class="manage_page_container">
	...
	<a style="margin:30px;" href="../cms-landing.php" class="btn btn-info">DONE</a>
		...
		<form name="form" action="edit-social-media-links.php " method="post" onSubmit="return validate(this)">
           <div class="page_actions edit_page">
			<?php if($admin_access->cms_level > 1){ ?>
				<button name="form" type="submit" class="btn btn-success btn-large">Save</button>
				<hr />
             <?php }else{ ?>
            	<div class="alert">
...
<td>Facebook URL </td>
<td>
<input type="text" name="facebook" style="width:90%;"  value="<?php echo $facebook;  ?>" />
</td>
</tr>

<tr>
<td>Twitter active </td>
<td>
<?php
...
<td>Twitter URL </td>
<td>
<input type="text" name="twitter" style="width:90%;"  value="<?php echo $twitter;  ?>" />
</td>
</tr>
