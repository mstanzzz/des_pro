...
$msg = (isset($_GET['msg'])) ? $_GET['msg'] : '';
	...
	if(!isset($_SESSION['temp_fields']['content1'])) $_SESSION['temp_fields']['content1'] = $content1;
	if(!isset($_SESSION['temp_fields']['page_name'])) $_SESSION['temp_fields']['page_name'] = $page_name;
	...
	<form name="form" action="<?php echo SITEROOT."manage/cms/pages/page.php" ?>" method="post" enctype="multipart/form-data">
		...
		<fieldset class="edit_content">
                        ...
                        <div class="colcontainer formcols">
                            ...
                            <div class="twocols">
                                <input type="text" id="page_name" name="page_name" value="<?php echo stripslashes($_SESSION['temp_fields']['page_name']); ?>" />
                            </div>
                        </div>
            ...
            <legend>Page Content <i class="icon-minus-sign icon-white"></i></legend>
                        ...
                        <div class="colcontainer formcols">
                            ...
                            <div class="twocols">
                                <input type="text" id="page_heading" name="page_heading" value="<?php echo stripslashes($_SESSION['temp_fields']['page_heading']); ?>" />
                            </div>
                        </div>
			...
			<div class="colcontainer"> 
				<textarea id="content" class="wysiwyg" name="content1"><?php echo stripslashes($_SESSION['temp_fields']['content1']); ?></textarea>
			</div>
		</fieldset>
