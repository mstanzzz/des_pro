...
if(!isset($_SESSION['temp_fields'])){
	...
	//$_SESSION['temp_fields']['intro'] = '';
	$_SESSION['temp_fields']['main_img_id'] = 0;
	$_SESSION['temp_fields']['video_img_id'] = 0;
	$_SESSION['temp_fields']['start_design_img_id'] = 0;
	$_SESSION['temp_fields']['specs_img_id'] = 0;
	$_SESSION['temp_fields']['cat_1_id'] = 0;
	$_SESSION['temp_fields']['cat_2_id'] = 0;
	$_SESSION['temp_fields']['cat_3_id'] = 0;
	$_SESSION['temp_fields']['cat_4_id'] = 0;
	$_SESSION['temp_fields']['url_name'] = '';
	$_SESSION['temp_fields']['meta_title'] = '';
	$_SESSION['temp_fields']['meta_keywords'] = '';
	$_SESSION['temp_fields']['meta_description'] = '';
	$_SESSION['temp_fields']['videos_btn_text'] = '';
	$_SESSION['temp_fields']['design_btn_text'] = '';
	$_SESSION['temp_fields']['specs_btn_text'] = '';
	$_SESSION['temp_fields']['cat_1_btn_text'] = '';
	$_SESSION['temp_fields']['cat_2_btn_text'] = '';
	$_SESSION['temp_fields']['cat_3_btn_text'] = '';
	$_SESSION['temp_fields']['cat_4_btn_text'] = '';

	$_SESSION['temp_fields']['heading'] = '';
	$_SESSION['temp_fields']['sub_heading'] = '';
	
	$_SESSION['temp_fields']['description_tab_content'] = '';
	$_SESSION['temp_fields']['doc_tab_content'] = '';
	
	$_SESSION['temp_fields']['show_on_home_page'] = 0;
