    	...
    	<div class="page_content">
            <fieldset>
				...
				<div class="colcontainer">
                    ...
                    <textarea id="input_heading" rows="3" name="heading"><?php echo $_SESSION['temp_fields']['heading']; ?></textarea> 
                    <div id="msg_heading">&nbsp;</div>   
                    <br />
                    <label id="label_sub_heading">Sub Heading </label>
                    <textarea id="input_sub_heading" rows="3" name="sub_heading"><?php echo $_SESSION['temp_fields']['sub_heading']; ?></textarea> 
		...
		<a id="doc"></a>
			<fieldset>
				...
				<div class="colcontainer">       
                    ...
                    <textarea class="wysiwyg" id="wysiwyg1" name="description_tab_content" style="width:800px!important; height:500px!important;"><?php echo stripslashes($_SESSION['temp_fields']['description']); ?></textarea>
