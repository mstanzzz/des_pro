...
if($_SESSION['img_type'] == 'gallery' && $_SESSION['gal_img_id'] > 0){		
	if(!in_array($_SESSION['gal_img_id'],$_SESSION['temp_fields']['temp_gallery'])){
		$_SESSION['temp_fields']['temp_gallery'][count($_SESSION['temp_fields']['temp_gallery'])] = $_SESSION['gal_img_id'];
	}
}
...
if(isset($_GET['delgalleryimgid'])){
	$key = array_search($_GET['delgalleryimgid'],$_SESSION['temp_fields']['temp_gallery']);
	if($key!==false){
		unset($_SESSION['temp_fields']['temp_gallery'][$key]);
		$_SESSION['temp_fields']['temp_gallery'] = array_values($_SESSION['temp_fields']['temp_gallery']);
	}
}

if(isset($_POST['set_cat'])){
	$num_cat = $_POST['set_cat'];
	$_SESSION['temp_fields']['cat_'.$num_cat.'_id'] = (isset($_POST['cat_id'])) ? $_POST['cat_id'] : 0;
}
...
if(isset($_POST['add_tab'])){
	...
	$indx = count($_SESSION['temp_fields']['temp_tabs']);
	
	$_SESSION['temp_fields']['temp_tabs'][$indx]['tab_text'] = $tab_text;
	$_SESSION['temp_fields']['temp_tabs'][$indx]['content'] = $content;
	$_SESSION['temp_fields']['temp_tabs'][$indx]['active'] = 1;
	$_SESSION['temp_fields']['temp_tabs'][$indx]['display_order'] = $indx;
}
...
if(isset($_POST['del_tab'])){
	...
	unset($_SESSION['temp_fields']['temp_tabs'][$indx]);
	$_SESSION['temp_fields']['temp_tabs'] = array_values($_SESSION['temp_fields']['temp_tabs']);
...
if(isset($_POST['add_doc'])){
	...
	if($doc_id > 0){
		$indx = count($_SESSION['temp_fields']['temp_docs']);	
		$_SESSION['temp_fields']['temp_docs'][$indx]['doc_id'] = $doc_id;
		$_SESSION['temp_fields']['temp_docs'][$indx]['name'] = $name;
		$_SESSION['temp_fields']['temp_docs'][$indx]['file_name'] = $file_name;
	}
...
if(isset($_POST['add_video'])){
	...
	if($result->num_rows > 0){
		...
		$indx = count($_SESSION['temp_fields']['temp_videos']);
		$_SESSION['temp_fields']['temp_videos'][$indx]['video_id'] = $video_id;
		$_SESSION['temp_fields']['temp_videos'][$indx]['youtube_id'] = $obj->youtube_id;
		$_SESSION['temp_fields']['temp_videos'][$indx]['name'] = $obj->name;
	}
}
...
if(isset($_POST['add_selected_img'])){
	...
	if($sel_img_id  > 0){
		if($img_type == 'main'){
			$_SESSION['temp_fields']['main_img_id'] = $sel_img_id;
		}
		if($img_type == 'gallery'){
			$_SESSION['temp_fields']['temp_gallery'][] = $sel_img_id;
		}
		if($img_type == 'video'){
			$_SESSION['temp_fields']['video_img_id'] = $sel_img_id;
		}
		if($img_type == 'start_design'){
			$_SESSION['temp_fields']['start_design_img_id'] = $sel_img_id;
		}
		if($img_type == 'specs'){
			$_SESSION['temp_fields']['specs_img_id'] = $sel_img_id;
		}
	}
}
...
if(isset($_GET['remove_video'])){
	foreach($_SESSION['temp_fields']['temp_videos'] as $key => $val){
		if($_GET['delvidid'] == $val['video_id']){
			unset($_SESSION['temp_fields']['temp_videos'][$key]);
			$_SESSION['temp_fields']['temp_videos'] = array_values($_SESSION['temp_fields']['temp_videos']);
		}
	}
}
...
if(isset($_GET['remove_doc'])){
	...
	$doc_id = $_GET['doc_id'];
	foreach($_SESSION['temp_fields']['temp_docs'] as $key => $val){
		if($val['doc_id'] = $doc_id){
			unset($_SESSION['temp_fields']['temp_docs'][$key]);
			$_SESSION['temp_fields']['temp_docs'] = array_values($_SESSION['temp_fields']['temp_docs']);
		}
	}
	//print_r($_SESSION['temp_fields']['temp_docs']);
}
...
if(isset($_POST['set_active_and_display_order'])){
	...
	foreach($_SESSION['temp_fields']['temp_tabs'] as $k => $v){
		$_SESSION['temp_fields']['temp_tabs'][$k]['active'] = 0;
	}
	
	
	foreach($actives as $val){
		$_SESSION['temp_fields']['temp_tabs'][$val]['active'] = 1;
	}


	if(is_array($display_orders)){		
		foreach($display_orders as $key => $val){			
			$_SESSION['temp_fields']['temp_tabs'][$key]['display_order'] = $val;
		}		
	}
...
if(!isset($_SESSION['temp_fields'])){

	$keyword_landing_id = (isset($_GET['keyword_landing_id'])) ? $_GET['keyword_landing_id'] : 0;
	$_SESSION['temp_fields']['keyword_landing_id'] = $keyword_landing_id;
	...
	//$_SESSION['temp_fields']['intro'] = $intro;
	$_SESSION['temp_fields']['main_img_id'] = $main_img_id;
	$_SESSION['temp_fields']['video_img_id'] = $video_img_id;
	$_SESSION['temp_fields']['start_design_img_id'] = $start_design_img_id;
	$_SESSION['temp_fields']['specs_img_id'] = $specs_img_id;
	$_SESSION['temp_fields']['cat_1_id'] = $cat_1_id;
	$_SESSION['temp_fields']['cat_2_id'] = $cat_2_id;
	$_SESSION['temp_fields']['cat_3_id'] = $cat_3_id;
	$_SESSION['temp_fields']['cat_4_id'] = $cat_4_id;
	$_SESSION['temp_fields']['url_name'] = $url_name;
	$_SESSION['temp_fields']['meta_title'] = $meta_title;
	$_SESSION['temp_fields']['meta_keywords'] = $meta_keywords;
	$_SESSION['temp_fields']['meta_description'] = $meta_description;
	
	$_SESSION['temp_fields']['videos_btn_text'] = $videos_btn_text;
	$_SESSION['temp_fields']['design_btn_text'] = $design_btn_text;
	$_SESSION['temp_fields']['specs_btn_text'] = $specs_btn_text;
	$_SESSION['temp_fields']['cat_1_btn_text'] = $cat_1_btn_text;
	$_SESSION['temp_fields']['cat_2_btn_text'] = $cat_2_btn_text;
	$_SESSION['temp_fields']['cat_3_btn_text'] = $cat_3_btn_text;
	$_SESSION['temp_fields']['cat_4_btn_text'] = $cat_4_btn_text;
	
	$_SESSION['temp_fields']['description_tab_content'] = $description_tab_content;
	$_SESSION['temp_fields']['doc_tab_content'] = $doc_tab_content;

	
	$_SESSION['temp_fields']['heading'] = $heading;
	$_SESSION['temp_fields']['sub_heading'] = $sub_heading;
	
	$_SESSION['temp_fields']['show_on_home_page'] = $show_on_home_page;
	...
	$_SESSION['temp_fields']['temp_gallery'] = array();						
	while($row = $result->fetch_object()){
		$_SESSION['temp_fields']['temp_gallery'][] = $row->img_id;
	}
	
	$_SESSION['temp_fields']['temp_tabs'] = array();
	$sql = "SELECT *   
	...
	$i = 0;									
	while($row = $result->fetch_object()) {
		$_SESSION['temp_fields']['temp_tabs'][$i]['tab_text'] = $row->tab_text;
		$_SESSION['temp_fields']['temp_tabs'][$i]['active'] = $row->active;
		$_SESSION['temp_fields']['temp_tabs'][$i]['display_order'] = $row->display_order;
		$_SESSION['temp_fields']['temp_tabs'][$i]['content'] = $row->content;
		$i++;
	}
	
	$_SESSION['temp_fields']['temp_docs'] = array();
	...
	$i = 0;									
	while($row = $result->fetch_object()) {
		$_SESSION['temp_fields']['temp_docs'][$i]['doc_id'] = $row->doc_id;
		$_SESSION['temp_fields']['temp_docs'][$i]['name'] = $row->name;
		$_SESSION['temp_fields']['temp_docs'][$i]['file_name'] = $row->file_name;
		$i++;
	}
	
	$_SESSION['temp_fields']['temp_videos'] = array();
	...
	$i = 0;									
	while($row = $result->fetch_object()) {
		$_SESSION['temp_fields']['temp_videos'][$i]['video_id'] = $row->video_id;
		$_SESSION['temp_fields']['temp_videos'][$i]['youtube_id'] = $row->youtube_id;
		$_SESSION['temp_fields']['temp_videos'][$i]['name'] = $row->name;
		$i++;
	}
...
<div class="manage_page_container">
	...
	<?php 
		...
		<input type="hidden" name="keyword_landing_id" value="<?php echo $_SESSION['temp_fields']['keyword_landing_id']; ?>">
        ...
        <div class="page_content edit_page">
            ...
            <fieldset>
				...
				<div class="colcontainer">
                    ...
                    <textarea id="input_heading" rows="3" name="heading"><?php echo stripslashes($_SESSION['temp_fields']['heading']); ?></textarea> 
                    <div id="msg_heading">&nbsp;</div>   
                    <br />
    
                        
                    <label id="label_sub_heading">Sub Heading </label>
                    <textarea id="input_sub_heading" rows="3" name="sub_heading"><?php echo stripslashes($_SESSION['temp_fields']['sub_heading']); ?></textarea> 
            ...
            <fieldset>
				...
				<div class="colcontainer">
					<?php
					if($_SESSION['temp_fields']['main_img_id'] > 0){	

						$sql = "SELECT file_name FROM image
							WHERE img_id = '".$_SESSION['temp_fields']['main_img_id']."'";
                    ...
                    <?php       
					foreach($_SESSION['temp_fields']['temp_gallery'] as $val){
						$sql = "SELECT file_name FROM image
								WHERE img_id = '".$val."'";
						$img_res = $dbCustom->getResult($db,$sql);
						if($img_res->num_rows > 0){
			...
			<fieldset>
				<legend>Video Link Image </legend>
                    ...
                    <div class="colcontainer">
						<?php
						if($_SESSION['temp_fields']['video_img_id'] > 0){	

							$sql = "SELECT file_name FROM image
							WHERE img_id = '".$_SESSION['temp_fields']['video_img_id']."'";
							$img_res = $dbCustom->getResult($db,$sql);
                        ...
                        <div class="twocols">
                            ...
                            <input style="width:300px;" type="text" id="input_videos_btn_text" name="videos_btn_text" value="<?php echo $_SESSION['temp_fields']['videos_btn_text']; ?>" />
				...
				<legend>Start Design Link Image </legend>
					<div class="colcontainer">
						<?php
						if($_SESSION['temp_fields']['start_design_img_id'] > 0){	

							$sql = "SELECT file_name FROM image
							WHERE img_id = '".$_SESSION['temp_fields']['start_design_img_id']."'";
							$img_res = $dbCustom->getResult($db,$sql);
                        ...
                        <div class="twocols">
                            ...
                            <input style="width:300px;" type="text" id="input_design_btn_text" name="design_btn_text" value="<?php echo $_SESSION['temp_fields']['design_btn_text']; ?>" />
				...
				<legend>Specifications Link Image </legend>
					<div class="colcontainer">
						<?php
						if($_SESSION['temp_fields']['specs_img_id'] > 0){	

							$sql = "SELECT file_name FROM image
							WHERE img_id = '".$_SESSION['temp_fields']['specs_img_id']."'";
							$img_res = $dbCustom->getResult($db,$sql);
                        ...
                        <div class="twocols">
                            ...
                            <input style="width:300px;" type="text" id="input_specs_btn_text" name="specs_btn_text" value="<?php echo $_SESSION['temp_fields']['specs_btn_text']; ?>" />
			...
			<fieldset>
				...
				<div class="colcontainer">
					...
					$sql = "SELECT category.name
							...
							AND category.cat_id = '".$_SESSION['temp_fields']['cat_1_id']."'";
					$result = $dbCustom->getResult($db,$sql);			
					if($result->num_rows > 0){
						$object = $result->fetch_object();						
					...
					<div class="twocols">
                        ...
                        <input style="width:300px;" type="text" id="input_cat_1_btn_text" name="cat_1_btn_text" value="<?php echo $_SESSION['temp_fields']['cat_1_btn_text']; ?>" />
			...
			<fieldset>
				...
				<div class="colcontainer">
					...
					$sql = "SELECT category.name
							...
							FROM category, image 
							WHERE category.img_id = image.img_id
							AND category.cat_id = '".$_SESSION['temp_fields']['cat_2_id']."'";
					$result = $dbCustom->getResult($db,$sql);			
					if($result->num_rows > 0){
						$object = $result->fetch_object();						
						$file_name = $object->file_name;
                    ...
                    <div class="twocols">
                        ...
                        <input style="width:300px;" type="text" id="input_cat_2_btn_text" name="cat_2_btn_text" value="<?php echo $_SESSION['temp_fields']['cat_2_btn_text']; ?>" />
			...
			<fieldset>
				...
				<div class="colcontainer">
					...
					$sql = "SELECT category.name
							...
							FROM category, image 
							WHERE category.img_id = image.img_id
							AND category.cat_id = '".$_SESSION['temp_fields']['cat_3_id']."'";
					$result = $dbCustom->getResult($db,$sql);			
					if($result->num_rows > 0){
						$object = $result->fetch_object();						
						$file_name = $object->file_name;
                    ...
                    <div class="twocols">
                        ...
                        <input style="width:300px;" type="text" id="input_cat_3_btn_text" name="cat_3_btn_text" value="<?php echo $_SESSION['temp_fields']['cat_3_btn_text']; ?>" />
 			...
 			<fieldset>
				...
				<div class="colcontainer">
					...
					$sql = "SELECT category.name
							...
							FROM category, image 
							WHERE category.img_id = image.img_id
							AND category.cat_id = '".$_SESSION['temp_fields']['cat_4_id']."'";
					$result = $dbCustom->getResult($db,$sql);			
					if($result->num_rows > 0){
						$object = $result->fetch_object();						
						$file_name = $object->file_name;
                    ...
                    <div class="twocols">
                        ...
                        <input style="width:300px;" type="text" id="input_cat_4_btn_text" name="cat_4_btn_text" value="<?php echo $_SESSION['temp_fields']['cat_4_btn_text']; ?>" />
            ...
            <fieldset>
            	...
            	<div class="colcontainer">
                    <div class="colcontainer formcols">
                        ...
                        <div class="twocols">
                            <input id="url_name" type="text" name="url_name" value="<?php echo stripslashes($_SESSION['temp_fields']['url_name']); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="colcontainer formcols">
                        ...
                        <div class="twocols">
                            <input id="meta_title" type="text" name="meta_title" value="<?php echo stripslashes($_SESSION['temp_fields']['meta_title']); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="colcontainer formcols">
                        ...
                        <div class="twocols">
                            <textarea id="meta_keywords" name="meta_keywords" cols="20" rows="6"><?php echo stripslashes($_SESSION['temp_fields']['meta_keywords']); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="colcontainer formcols">
                        ...
                        <div class="twocols">
                            <textarea id="meta_description" name="meta_description" cols="20" rows="6"><?php echo stripslashes($_SESSION['temp_fields']['meta_description']); ?></textarea>
                        </div>
                    </div>
            	</div>
            </fieldset>
            ...
            <fieldset>
				...
				<div class="colcontainer">       
					...
					<?php echo stripslashes($_SESSION['temp_fields']['description_tab_content']); ?></textarea>

					<br /><br />

                    <label>Document Area Text</label>
                    <textarea class="wysiwyg" id="wysiwyg2" name="doc_tab_content" style="width:800px!important; height:300px!important;"><?php echo stripslashes($_SESSION['temp_fields']['doc_tab_content']); ?></textarea>
				...
				<table cellpadding="10" cellspacing="0">
					...
					<?php
					//print_r($_SESSION['temp_fields']['temp_docs']);
					foreach($_SESSION['temp_fields']['temp_docs'] as $val) {
						$block = "<tr>";
						//label
         ...
         <fieldset class="edit_videos">
               <legend>Show on Home Page </legend>
					...
					<?php if($_SESSION['temp_fields']['show_on_home_page']) echo "checked='checked'"; ?>/>
                    </div>
			</fieldset>
			...
			<fieldset>
               ...
               <form  name="tabs_form" action="edit-keyword-landing.php" method="post" enctype="multipart/form-data" >	           
					...
					<table cellpadding="10" cellspacing="0">
						...
						$block = "<tr>";
						foreach($_SESSION['temp_fields']['temp_tabs'] as $key => $val){
		...
		<fieldset class="edit_videos" id="product_videos">
            ...
            <table cellpadding="10" cellspacing="0">
					...
					<?php
					$block = '';       
					foreach($_SESSION['temp_fields']['temp_videos'] as $val){						
						$block .= "<tr>";
