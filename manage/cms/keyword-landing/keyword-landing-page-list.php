...
if(isset($_POST['add_keyword_landing'])){
	...
	if(!$stmt->bind_param('ssssssssssssssssiiiiiiiiiii'
					...
					,$description_tab_content
					,$doc_tab_content
					,$_SESSION['temp_fields']['main_img_id']
					,$_SESSION['temp_fields']['video_img_id']
					,$_SESSION['temp_fields']['start_design_img_id']
					,$_SESSION['temp_fields']['specs_img_id']
					,$_SESSION['temp_fields']['cat_1_id']
					,$_SESSION['temp_fields']['cat_2_id']
					,$_SESSION['temp_fields']['cat_3_id']
					,$_SESSION['temp_fields']['cat_4_id']
					,$ts
					,$show_on_home_page	
		...
		foreach($_SESSION['temp_fields']['temp_tabs'] as $val){
