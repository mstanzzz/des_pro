...
if(!isset($_SESSION["temp_fields"]["spec_cat_id"])) $_SESSION["temp_fields"]["spec_cat_id"] = 0;
if(!isset($_SESSION["temp_fields"]['description'])) $_SESSION["temp_fields"]['description'] = '';
if(!isset($_SESSION["temp_fields"]['spec_details'])) $_SESSION["temp_fields"]['spec_details'] = '';
