...
$result = $dbCustom->getResult($db,$sql);	
	...
	if(!isset($_SESSION['temp_fields']['content_short1'])) $_SESSION['temp_fields']['content_short1'] = $content_short1;
			...
			<div class="page_content edit_page">
				<fieldset class="edit_content">
					...
					<div class="colcontainer formcols">
						...
						<div class="twocols">
							<input id="page_heading" type="text" name="page_heading" value="<?php echo stripslashes($_SESSION['temp_fields']['page_heading']); ?>" />
						</div>
					</div>
				...
				<fieldset class="edit_images">
                   ...
                   <div class="colcontainer formcols">
					...
					<div class="colcontainer">
						...
						<textarea id="content_short1" class="wysiwyg small" name="content_short1" ><?php echo $_SESSION['temp_fields']['content_short1']; ?></textarea>
					</div>
