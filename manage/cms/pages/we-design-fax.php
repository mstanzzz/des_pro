...
if($new_uploaded_file_id > 0){
	$_SESSION['temp_fields']['download_form_file_id'] = $new_uploaded_file_id; 
}
$new_img_id = (isset($_GET['new_img_id'])) ? $_GET['new_img_id'] : 0;
if($new_img_id > 0){
	$_SESSION['temp_fields']['form_img_id'] = $new_img_id; 
}
...
if(!isset($_SESSION['temp_fields']['download_form_file_id'])) $_SESSION['temp_fields']['download_form_file_id'] = $download_form_file_id;
if(!isset($_SESSION['temp_fields']['form_img_id'])) $_SESSION['temp_fields']['form_img_id'] = $form_img_id;
if(!isset($_SESSION['temp_fields']['content'])) $_SESSION['temp_fields']['content'] = $content;
if(!isset($_SESSION['temp_fields']['design_fax_number'])) $_SESSION['temp_fields']['design_fax_number'] = $design_fax_number;
...
<input type="text" name="design_fax_number"  style="width:520px" value="<?php echo stripslashes($_SESSION['temp_fields']['design_fax_number']); ?>">
                    
<label>content</label>
<textarea id="content" class="wysiwyg" name="content">
<?php echo stripslashes($_SESSION['temp_fields']['content']); ?>
</textarea>
