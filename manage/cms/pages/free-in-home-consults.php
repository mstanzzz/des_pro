...
if(isset($_POST['update_free_in_home_consults'])){
	...
	$seo_name	= 'free-in-home-consults';
	$page	= 'free-in-home-consults';
	$seo_name = (isset($_POST['seo_name']))? trim($_POST['seo_name']) : '';
	$seo_name = str_replace ('\'', '' , $seo_name);
	$seo_name = str_replace ('\"', '' , $seo_name);
	$seo_name = str_replace (' ', '-' , $seo_name);
	$title = (isset($_POST['title']))? trim(addslashes($_POST['title'])) : 'free-in-home-consults';
	$keywords = (isset($_POST['keywords']))? trim(addslashes($_POST['keywords'])) : 'free-in-home-consults';
	$description = (isset($_POST['description']))? trim(addslashes($_POST['description'])) : 'free-in-home-consults';
	$page_heading = (isset($_POST['page_heading']))? trim(addslashes($_POST['page_heading'])) : 'free-in-home-consults';
...
function ajax_set_page_session(){
	...
	var q_str = "?page=free-in-home-consults"+get_query_str();
...
<center><h1>Free In Home Consultation Page</h1></center>
...
<tr>
<td>p_7_text</td>
<td><textarea id="p_7_text" name="p_7_text"><?php echo stripslashes($_SESSION['temp_fields']['p_7_text']); ?></textarea></td>
</tr>
