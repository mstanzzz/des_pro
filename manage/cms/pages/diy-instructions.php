...
$page_title = "Editing: diy-instructions";
$page_group = "diy-instructions";
...
if(isset($_POST['submit'])){
	...
	$seo_name	= 'diy-instructions';
	$page	= 'diy-instructions';
	$seo_name = (isset($_POST['seo_name']))? trim($_POST['seo_name']) : 'diy-instructions';
	$seo_name = str_replace ('\'', '' , $seo_name);
	$seo_name = str_replace ('\"', '' , $seo_name);
	$seo_name = str_replace (' ', '-' , $seo_name);
	$title = (isset($_POST['title']))? trim(addslashes($_POST['title'])) : 'diy-instructions';
	$keywords = (isset($_POST['keywords']))? trim(addslashes($_POST['keywords'])) : 'diy-instructions';
	$description = (isset($_POST['description']))? trim(addslashes($_POST['description'])) : 'diy-instructions';
	$page_heading = (isset($_POST['page_heading']))? trim(addslashes($_POST['page_heading'])) : 'diy-instructions';
...
<center><h1>DIY Instructions Page</h1></center>
<form name="form" action="diy_instructions.php" method="post" enctype="multipart/form-data">
...
$url_str .= "?ret_page=diy-instructions";
