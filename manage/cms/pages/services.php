...
if(isset($_POST['update_services'])){
	...
	$_SESSION['temp_fields']['top_4'] = $top_4;	
	$_SESSION['temp_fields']['service_1_text'] = $service_1_text;	
	$_SESSION['temp_fields']['service_2_text'] = $service_2_text;	
	$_SESSION['temp_fields']['service_3_text'] = $service_3_text;	
	$_SESSION['temp_fields']['service_4_text'] = $service_4_text;	
	...
	$seo_name	= 'services';
	$page	= 'services';
	$seo_name = (isset($_POST['seo_name']))? trim($_POST['seo_name']) : 'services';
	$seo_name = str_replace ('\'', '' , $seo_name);
	$seo_name = str_replace ('\"', '' , $seo_name);
	$seo_name = str_replace (' ', '-' , $seo_name);
	$title = (isset($_POST['title']))? trim(addslashes($_POST['title'])) : 'services';
	$keywords = (isset($_POST['keywords']))? trim(addslashes($_POST['keywords'])) : 'services';
	$description = (isset($_POST['description']))? trim(addslashes($_POST['description'])) : 'services';
	$page_heading = (isset($_POST['page_heading']))? trim(addslashes($_POST['page_heading'])) : 'services';
...
if(!isset($_SESSION['temp_fields']['top_4'])) $_SESSION['temp_fields']['top_4'] = $top_4;
if(!isset($_SESSION['temp_fields']['service_1_text'])) $_SESSION['temp_fields']['service_1_text'] = $service_1_text;
if(!isset($_SESSION['temp_fields']['service_2_text'])) $_SESSION['temp_fields']['service_2_text'] = $service_2_text;
if(!isset($_SESSION['temp_fields']['service_3_text'])) $_SESSION['temp_fields']['service_3_text'] = $service_3_text;
if(!isset($_SESSION['temp_fields']['service_4_text'])) $_SESSION['temp_fields']['service_4_text'] = $service_4_text;
...
<div class="manage_page_container">
	...
	<div class="manage_main"> 
		<center><h1>Services Page</h1></center>
	
		<form name="form" action="services.php" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="services_id" value="<?php echo $_SESSION['services_id']; ?>">
			...
			<div class="colcontainer">                
				<label>top_1 (mobile)</label>
				<input type="text" name="top_1"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['top_1']); ?>">
                    
				<label>top_2 (desktop)</label>
				<input type="text" name="top_2"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['top_2']); ?>">

				<label>top_3</label>
				<input type="text" name="top_3"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['top_3']); ?>">

<label>top_4</label>
<input type="text" name="top_4"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['top_4']); ?>">



<label>service_1_text (In-home design consultation)</label>
<textarea id="service_1_text"  name="service_1_text"><?php echo stripslashes($_SESSION['temp_fields']['service_1_text']); ?></textarea>


<label>service_2_text (Online design request (AKA Virtual design))</label>
<textarea id="service_2_text"  name="service_2_text"><?php echo stripslashes($_SESSION['temp_fields']['service_2_text']); ?></textarea>

<label>service_3_text (Online design request (Pre-Assembly service))</label>
<textarea id="service_3_text"  name="service_3_text"><?php echo stripslashes($_SESSION['temp_fields']['service_3_text']); ?></textarea>


<label>service_4_text (Installation and Virtual showroom tour)</label>
<textarea id="service_4_text"  name="service_4_text"><?php echo stripslashes($_SESSION['temp_fields']['service_4_text']); ?></textarea>

<label>p_1_head</label>
<input type="text" name="p_1_head"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['p_1_head']); ?>">

<label>p_1_text</label>
<textarea id="p_1_text"  name="p_1_text"><?php echo stripslashes($_SESSION['temp_fields']['p_1_text']); ?></textarea>
	

<label>p_2_head</label>
<input type="text" name="p_2_head"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['p_2_head']); ?>">
				
<label>p_2_text</label>
<textarea id="p_2_text"  name="p_2_text"><?php echo stripslashes($_SESSION['temp_fields']['p_2_text']); ?></textarea>


<label>p_3_head</label>
<input type="text" name="p_3_head"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['p_3_head']); ?>">

<label>p_3_text</label>
<textarea id="p_3_text"  name="p_3_text"><?php echo stripslashes($_SESSION['temp_fields']['p_3_text']); ?></textarea>


<label>p_4_head</label>
<input type="text" name="p_4_head"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['p_4_head']); ?>">



	<label>p_4_text</label>
	<textarea id="p_4_text"  name="p_4_text"><?php echo stripslashes($_SESSION['temp_fields']['p_4_text']); ?></textarea>

	
				<label>p_5_head</label>
				<input type="text" name="p_5_head"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['p_5_head']); ?>">
	<label>p_5_text</label>
	<textarea id="p_5_text"  name="p_5_text"><?php echo stripslashes($_SESSION['temp_fields']['p_5_text']); ?></textarea>



	
				<label>p_6_head</label>
				<input type="text" name="p_6_head"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['p_6_head']); ?>">
	<label>p_6_text</label>
	<textarea id="p_6_text"  name="p_6_text"><?php echo stripslashes($_SESSION['temp_fields']['p_6_text']); ?></textarea>

				<label>p_7_head</label>
				<input type="text" name="p_7_head"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['p_7_head']); ?>">
	<label>p_7_text</label>
	<textarea id="p_7_text"  name="p_7_text"><?php echo stripslashes($_SESSION['temp_fields']['p_7_text']); ?></textarea>


				<label>p_8_head</label>
				<input type="text" name="p_8_head"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['p_8_head']); ?>">

	<label>p_8_text</label>
	<textarea id="p_8_text"  name="p_8_text"><?php echo stripslashes($_SESSION['temp_fields']['p_8_text']); ?></textarea>
		
				<label>p_9_head</label>
				<input type="text" name="p_9_head"  style="width:90%" value="<?php echo stripslashes($_SESSION['temp_fields']['p_9_head']); ?>">

	<label>p_9_text</label>
	<textarea id="p_9_text"  name="p_9_text"><?php echo stripslashes($_SESSION['temp_fields']['p_9_text']); ?></textarea>
