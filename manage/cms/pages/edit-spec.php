...
if(!isset($_SESSION["temp_fields"]["spec_cat_id"])) $_SESSION["temp_fields"]["spec_cat_id"] = $spec_cat_id;
if(!isset($_SESSION["temp_fields"]['description'])) $_SESSION["temp_fields"]['description'] = $description;
if(!isset($_SESSION["temp_fields"]['spec_details'])) $_SESSION["temp_fields"]['spec_details'] = $spec_details;
...
while($row = $result->fetch_object()) {
	$selected = ($_SESSION["temp_fields"]["spec_cat_id"] == $row->spec_cat_id) ? "selected" : '';
...
value="<?php echo stripslashes($_SESSION["temp_fields"]['spec_details']); ?>" />
<br />
<label>Spec Item description</label>
<textarea  style="width:100%; height:120px;" name="description"><?php echo stripslashes($_SESSION["temp_fields"]['description']); ?></textarea>
</form>
<br /><br />
<br /><br />
</div>
