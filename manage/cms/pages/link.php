            ...
            <form name="add_link" action="link.php" method="post">
             ...
             <tr>
                ...
                ?>
                    ...
                    <option value="/custom-closet-system-faq.html">support - FAQ</option>
                    <option value="/custom-closet-system-contact.html">support - contact us</option>
                    <option value="/custom-closet-system-guides-and-tips.html">support - guides & tips</option>
