...
if(!isset($_SESSION['temp_fields']['intro'])) $_SESSION['temp_fields']['intro'] = $intro;
		...
		<div class="page_content edit_page">
            ...
            <fieldset class="edit_content">
                ...
                <div class="colcontainer"> 
                    ...
                    <textarea id="intro" class="wysiwyg" name="intro"><?php echo stripslashes($_SESSION['temp_fields']['intro']); ?></textarea>
                </div>
