...
<a onClick="regularSubmit();" href="#" class="btn btn-success btn-large">Save </a>

<a href="<?php echo SITEROOT;?>manage/cms/pages/page.php" class="btn btn-large">Cancel &amp; Go Back</a>
