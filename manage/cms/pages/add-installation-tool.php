...
if(!isset($_SESSION['temp_fields']['display_order'])) $_SESSION['temp_fields']['display_order'] = 1;
	...
	<form name="form" action="installation-tools.php" method="post" target="_top">
		...
		<div class="lightboxcontent">
			...
			<fieldset>
				...
				<textarea cols="88" id="description" name="description"><?php echo $_SESSION['temp_fields']['description'] ?></textarea>
			</fieldset>
		</div>
		<div class="savebar">
