...
<div class="manage_page_container">
	...
	<textarea id="p_8_text" class="wysiwyg" name="p_8_text"><?php echo stripslashes($_SESSION['temp_fields']['p_8_text']); ?></textarea>
				...
				<input type="text" name="p_9_head"  style="width:520px" value="<?php echo stripslashes($_SESSION['temp_fields']['p_9_head']); ?>">

	<label>p_9_text</label>
	<textarea id="p_9_text" class="wysiwyg" name="p_9_text"><?php echo stripslashes($_SESSION['temp_fields']['p_9_text']); ?></textarea>
