...
$page_title = "Editing: account page";
$page_group = "account";
$page = "account";
$ts = time();
...
$sql = "SELECT account_id FROM account WHERE profile_account_id = '".$_SESSION['profile_account_id']."'"; 
...
if($result->num_rows == 0){
	...
	$_SESSION['account_id'] = (isset($_REQUEST['account_id'])) ? $_REQUEST['account_id'] : 0;
}
if(!is_numeric($_SESSION['account_id'])) $_SESSION['account_id'] = 0;
...
<form name="form" action="account.php" method="post" enctype="multipart/form-data">
