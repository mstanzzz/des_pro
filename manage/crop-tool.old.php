...
<link href="<?php echo SITEROOT; ?>css/manageStyle.css" rel="stylesheet" type="text/css" />
                ...
                <?php 
						...
						*/
                        ...
                        <div class='original'>
                            <h3>Original Image:</h3>
                            <div id='pre_cropped' >
                                <img src='../saascustuploads/".$_SESSION['profile_account_id']."/cart/".$_SESSION['pre_cropped_fn']."' />
                            </div>
                        </div>
                        ";
