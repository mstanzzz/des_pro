...
<table cellpadding="10" cellspacing="0" border="0" width="100%">
	...
	<td width="10%">
	<a href="order-list.php?sortby=order_id&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Order Id
	<br />
	<a href="order-list.php?sortby=order_id&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
	</td>
 
	<td width="20%">
	<a href="order-list.php?sortby=billing_name&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Billing Name
	<br />
	<a href="order-list.php?sortby=billing_name&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
	</td>

	<td width="20%">
	<a href="order-list.php?sortby=order_date&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Order Date
	<br />
	<a href="order-list.php?sortby=order_date&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
	</td>

	<td width="10%">
	<a href="order-list.php?sortby=total&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	$ Total
	<br />
	<a href="order-list.php?sortby=total&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
	</td>
	<td width="8%">Type</td>
	<td width="8%">State</td>
...
while($row = $result->fetch_object()) {
	...
	*/
	...
	$url_str = SITEROOT."manage/order-management/master/";
	$url_str .= "order.php";
	...
	$block .= "<td valign='top'>";
	$block .= "<a class='btn btn-small' href='".$url_str."'> Edit </a>";
	$block .= "</td>";
