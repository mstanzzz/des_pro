...
if(isset($_POST['submit_add_customer'])){
	...
	$first_name = isset($_POST["shipping_name_first"])? trim(addslashes($_POST["shipping_name_first"])) : '';
	$last_name = isset($_POST["shipping_name_last"])? trim(addslashes($_POST["shipping_name_last"])) : '';
	...
	$username = isset($_POST["username"])? trim(addslashes($_POST["username"])) : '';
...
echo getPagination($total_rows, $rows_per_page, $pagenum, $truncate, $last, "../customer/customer-list.php", $sortby, $a_d, $uid1, 0, $search_str); 
	...
	<td width="15%;">
	<a href="customer-list.php?sortby=visited&a_d=a"><img width="30" src="<?php echo SITEROOT."manage/images/up.jpg" ?>"></a>
	<br />
	Last Visited
	<br />
	<a href="customer-list.php?sortby=visited&a_d=d"><img width="30" src="<?php echo SITEROOT."manage/images/down.jpg" ?>"></a>								
	</td>
	<td width="11%">&nbsp;</td>
	<td width="11%">&nbsp;</td>
    <td width="11%">&nbsp;</td>
...
$block .= "<td><a class='btn btn-info fancybox fancybox.iframe' href='view-email-customer.php?customer_id=".$row->id."'>View</a></td>"; 
...
<input type='hidden' id='".$row->id."' class='itemId' value='".$row->id."' />Del</a></td>";
$block .= '</tr>';
