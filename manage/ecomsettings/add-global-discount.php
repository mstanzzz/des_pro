...
if(!isset($_SESSION['temp_fields']['hide'])) $_SESSION['temp_fields']['hide'] = 1;
if(!isset($_SESSION['temp_fields']['when_active'])) $_SESSION['temp_fields']['when_active'] = 0;
if(!isset($_SESSION['temp_fields']['when_expired'])) $_SESSION['temp_fields']['when_expired'] = 0;
...
if(!isset($_SESSION['temp_fields']['type'])) $_SESSION['temp_fields']['type'] = '';
if(!isset($_SESSION['temp_fields']['coupon_code'])) $_SESSION['temp_fields']['coupon_code'] = '';
if(!isset($_SESSION['temp_fields']['percent_off'])) $_SESSION['temp_fields']['percent_off'] = '';
if(!isset($_SESSION['temp_fields']['amount_off'])) $_SESSION['temp_fields']['amount_off'] = '';
if(!isset($_SESSION['temp_fields']['if_greater_than'])) $_SESSION['temp_fields']['if_greater_than'] = 0;
if(!isset($_SESSION['temp_fields']['if_less_than'])) $_SESSION['temp_fields']['if_less_than'] = 0;
if(!isset($_SESSION['temp_fields']['can_use_with_other_discounts'])) $_SESSION['temp_fields']['can_use_with_other_discounts'] = 1;
...
-->	
<textarea name="description"><?php echo ($_SESSION['temp_fields']['description']); ?></textarea> 
					</div> 
				</div>stripslashes
				<div class="colcontainer formcols">
					<div class="twocols">
