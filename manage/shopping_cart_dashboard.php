...
<script src="<?php echo SITEROOT; ?>css/jquery.js"></script>
<script>
...
<br />
<br />
<a href="<?php //echo SITEROOT; ?>cms/start.php">CMS</a>
<br />
<a href="<?php //echo SITEROOT; ?>cart/start.php">Cart</a>
<br />
    ...
    <div class="inner_container">
      <div class="left">
        <ul class="admin_dashboard_row">
          <li class="t_cat"><a href="cart/t-category.php">CMS</a></li>
