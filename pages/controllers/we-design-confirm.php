...
$msg .= "\n\n\r Thank you for your interest in Closets To Go!";
$msg .= "\n\n\r So that you may pick up where you left off,";
$msg .= " your design request data has been saved"; 
$msg .= " within the account we've set up on your behalf. Reset the temporary password by"; 
$msg .= " clicking this link or pasting into your web browser.";  
$msg .= "\n\n\r ".$link;
$msg .= "\n\n\r You may now finish the Design Request Form at your convenience."; 
$msg .= "In the meantime, learn more about how our "; 
$msg .= "<a href='".SITEROOT."process.html'>Process</a> works.";  
$msg .= "\n\n\r Thank you for trusting Closets To Go with your custom storage needs!";
$msg.= "\n\n\r";
$message .= $msg;
...
$msg .= "\n\n\r We&rsquo;ve received your Design Request Form!"; 
$msg .= "\n\n\r It&rsquo;s now on its way to our Design Team for review.";  
$msg .= "\n\n\r For your convenience, this form has been saved in the account we have ";    
$msg .= "set up on your behalf."; 
$msg .= "Reset the temporary password by clicking this ".$link." or pasting into your web browser."; 
$msg .= "\n\n\r A member of our Team will be contacting you shortly to gather any additional information"; 
$msg .= " needed and discuss next steps.  Please be sure to check your spam / junk folders."; 
$msg .= " In the meantime, learn more about how our "; 
$msg .= "<a href='".SITEROOT."process.html'>Process</a> works.";  
$msg .= "\n\n\r Thank you for trusting Closets To Go with your custom storage needs!";
$msg.= "\n\n\r";
...
$message.= "\n\n\r You may return to and finish the design at your convenience.";  
$message.= "\n\n\r";
$message.= $link;
$message.= "\n\n\r";
