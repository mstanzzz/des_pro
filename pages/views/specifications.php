...
<html lang="en">
	...
	<meta name="description" content="specifications"><link href="<?php echo SITEROOT; ?>app.css" rel="stylesheet"></head>
...
<!--								<a href="#" title="Back" class="back-link">-->
...
<!--								</a>-->
		...
		<section class="first-fixed-block covid-block clearfix">
			<figure class="first-fixed-block__img-group" style="background-image: url('<?php echo SITEROOT; ?>images/specification-header.png');">
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Specifications category</li>
									</ul>
								</div>
							</div>
						</div>
								...
								<div class="simple-block__border no-border p-0">
									<div class="row">
										<div class="col-12">
											<div class="simple-block__heading">
												<h2 class="simple-block__heading--heading text-center">Specifications Category</h2>
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="clo-12 col-lg-2">
											<a href="specifications-details.html" title="Specifications Details" class="specification-link first-el-mobile-top-border">
										...
										<div class="clo-12 col-lg-2">
											<a href="specifications-details.html" title="Specifications Details" class="specification-link">
												<span class="specification-link__img">
