...
<html lang="en">
	...
	<meta name="description" content="order"><link href="<?php echo SITEROOT; ?>app.css" rel="stylesheet"></head>

	<body class="clearfix page-order idea-folder-popup">
<?php
					...
					<div class="container-fluid">
						<div class="row justify-content-center">
							<div class="px-0 col-lg-8 px-lg-2 text-center mt-lg-4">
								...
								<div>
									<a href="#" title="Continue shopping" class="link-button">
										continue shopping
