...
<html lang="en">
	...
	<meta name="description" content="specifications details"><link href="<?php echo SITEROOT; ?>app.css" rel="stylesheet"></head>
	<body class="product-detail specification-page idea-folder-popup">
<?php
					...
					<div class="row">
						<div class="col-12">
							<div class="home-mobile-buttons-block__wrapper">
								<a href="specifications.html" title="Specifications Category" class="back-link">
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item" aria-current="page"><a href="specifications.html" title="Specifications Category">Specifications Category</a></li>
										<li class="breadcrumb-item active" aria-current="page">Specifications details</li>
									</ul>
								</div>
							</div>
						</div>
					  ...
					  <div class="row">
						 ...
						 <div class="col-12 col-lg-3">
							<div class="specification-detial-header__link-wrap">
							   <a href="specifications.html" title="Back to categories" class="specification-detial-header__link">back
							   to categories</a>
							</div>
						 </div>
					  </div>
									...
									<div class="row">
										<div class="col-12">
											<div class="product-detail__carousel image-gallery js-add-to-card-image-holder">
												<a href="https://www.youtube.com/embed/Wb0JINqX71w" title="Play Video" data-poster="images/yt-placeholder.png" >
											...
											<div id="collapse-two" class="collapse spec" aria-labelledby="heading-two"
												...
												<div class="card-collapse__body">
													<div class="specification-detial-wrap__specification-details">
														...
														<div class="row">
															<div class="col-12 col-lg-6">
																<a href="#" title="Download instructions"
															...
															<div class="col-12 col-lg-6">
																<a href="#" title="Download instructions 2"
																   class="specification-detial-wrap__download-link">
																	<span class="specification-detial-wrap__download-link--img">
																		<svg xmlns="http://www.w3.org/2000/svg"
																			 width="26" height="33.724"
															...
															<div class="col-12 col-lg-6">
																<a href="#" title="Download instructions 3"
																   class="specification-detial-wrap__download-link">
																	<span class="specification-detial-wrap__download-link--img">
																		<svg xmlns="http://www.w3.org/2000/svg"
																			 width="26" height="33.724"
															...
															<div class="col-12 col-lg-6">
																<a href="#" title="Download instructions 4"
																   class="specification-detial-wrap__download-link">
																	<span class="specification-detial-wrap__download-link--img">
																		<svg xmlns="http://www.w3.org/2000/svg"
																			 width="26" height="33.724"
