...
//see atom solutions product details pic modal
...
<div class="col-12 col-lg-3">                     
<form 
action="<?php echo "category-".$profile_cat_id."/".$name.".html"; ?>"
method="post">
<fieldset>
...
<li class="product-box" data-sub-html="Product description 1">
	<div>
		<div class="product-image">
			<?php
			$img_big=SITEROOT."saascustuploads/1/cart/large/".$val['file_name'];					
			$img=SITEROOT."saascustuploads/1/cart/small/".$val['file_name'];		
			?>
			<!--			
			<a href="<?php echo $img_big; ?>">			
		...
		<div class="see-detail-product-accessories">
			...
			$url_str = SITEROOT."product-".$val['profile_item_id']."/".$n.".html";
			?>
...
<li class="product-box" data-sub-html="Product description 1" data-html="#video1">
	<div>
		<div class="product-image">
			<?php
			$img=SITEROOT."saascustuploads/1/cart/medium/exwide/".$val['file_name'];		
			?>
			<img class="landscape-images" src="<?php echo $img; ?>" alt="<?php echo $val['name']; ?>">
		</div>
		<p class="product-title"><?php echo  $val['name']; ?></p>
		<p class="product-description__text"><?php echo $val['short_description']; ?></p>
	</div>
		...
		<div class="stars-review-price-btn">
			<div class=" stars-product-accessories">
				<div class="stars-container">
					...
					echo $icon_star_gold;
					?>
					<img src="<?php echo SITEROOT; ?>images/stars.svg" alt="<?php echo $val['name']; ?>">
				</div>
			</div>
			<div class="reviews-counter-product-accessories">
				<p>115 reviews</p>
...
<ul class="accessories-products landscape-accessories-products">
<?php
foreach($row_low_bottom_6_array as $val){
?>
<li class="product-box" data-sub-html="Product description 1" data-html="#video1">
	<div>
		<div class="product-image">
...
<ul class="accessories-products landscape-accessories-products">
<?php
foreach($row_low_bottom_2_array as $val){
?>
<li class="product-box" data-sub-html="Product description 1" data-html="#video1">
	<div>
		<div class="product-image">
...
<ul class="accessories-products landscape-accessories-products">
<?php
foreach($row_even_lower_bottom_6_array as $val){
?>
<li class="product-box" data-sub-html="Product description 1" data-html="#video1">
	<div>
		<div class="product-image">
...
<ul class="accessories-products landscape-accessories-products">
<?php
foreach($row_even_lower_bottom_2_array as $val){
?>
<li class="product-box" data-sub-html="Product description 1" data-html="#video1">
	<div>
		<div class="product-image">
