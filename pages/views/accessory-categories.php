...
<div class="row">
	<div class="col-12">
		<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page" title="Room Gallery">Accessories</li>
			</ul>
...
foreach($top_cat_array as $val){
	...
	$url_str = SITEROOT."category-".$val['profile_cat_id']."/".$n.".html";
?>
<div class="clo-12 col-lg-2">
	<a style="text-decoration:none; color:black;" 
	href="<?php echo $url_str; ?>" title="<?php echo $name; ?>" class="specification-link">
