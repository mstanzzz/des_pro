...
?>
<center><div style="margin:20%; color:blue; font-size:20px;">This Page Is Comming Soon.</div></center>
		...
		<section class="mobile-order-search covid-block mobile-idea-folder mobile-idea-folder--details js-mobile-idea-folder-header">
			...
			<div class="mobile-idea-folder--details__wparpper">
				...
				<div class="mobile-idea-folder--details__content">
					<p class="mobile-idea-folder--details__heading">Title house name 1</p>
...
?>
													...
													<div class="idea-folder-details-specification--content">
														<fieldset>
															<div class="house-checkbox">
																<input class="custom-checkbox js-load-confirm-modal" id="checkbox-1" name="Share with Closets To Go" type="checkbox" value="value1"  data-target="#confirmModal">
												...
												<div class="tab-pane fade" id="v-pills-global" role="tabpanel" aria-labelledby="v-pills-global-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Global</p>
																</div>
																<div class="col-4">
															...
															<div class="col-12 js-specification-sheet-box" style="display: none;">
																<div class="folder-wrapper__specification-sheet--wrapper">
																	...
																	<div class="folder-wrapper__specification-sheet--wrapper-content">
																		<p class="folder-wrapper__specification-sheet--wrapper-heading">Accessory</p>
																		...
																		<p class="folder-wrapper__specification-sheet--wrapper-heading">Material color</p>
																		...
																		<p class="folder-wrapper__specification-sheet--wrapper-heading">Door/drawer style</p>

																		<p class="folder-wrapper__specification-sheet--wrapper-text">There is no any items in category.</p>

																		<p class="folder-wrapper__specification-sheet--wrapper-heading">Decorative hardware (handles, knobs, hooks)</p>
																		...
																		<p class="folder-wrapper__specification-sheet--wrapper-heading">Wardrobe tube style and finish</p>
												...
												<div class="tab-pane fade" id="v-pills-living-room" role="tabpanel" aria-labelledby="v-pills-living-room-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Living Room</p>
																</div>
																<div class="col-4">
																	<p class="folder-wrapper__all-items">
																		<span class="folder-wrapper__all-items--img">5</span> images /
												...
												<div class="tab-pane fade" id="v-pills-bedroom" role="tabpanel" aria-labelledby="v-pills-bedroom-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Badroom</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-kitchen" role="tabpanel" aria-labelledby="v-pills-kitchen-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Kitchen</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-dining-room" role="tabpanel" aria-labelledby="v-pills-dining-room-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Dining room</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-family-room" role="tabpanel" aria-labelledby="v-pills-family-room-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Family room</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-guest-room" role="tabpanel" aria-labelledby="v-pills-guest-room-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Guest room</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-bathroom" role="tabpanel" aria-labelledby="v-pills-bathroom-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Bathroom</p>
																</div>
																<div class="col-4">
																	<p class="folder-wrapper__all-items">
																		<span class="folder-wrapper__all-items--img">5</span> images /
												...
												<div class="tab-pane fade" id="v-pills-game-room" role="tabpanel" aria-labelledby="v-pills-game-room-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Game Room</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-basement" role="tabpanel" aria-labelledby="v-pills-basement-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Basement</p>
																</div>
																<div class="col-4">
																	<p class="folder-wrapper__all-items">
																		<span class="folder-wrapper__all-items--img">5</span> images /
												...
												<div class="tab-pane fade" id="v-pills-home-office" role="tabpanel" aria-labelledby="v-pills-home-office-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Home Office</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-nursery" role="tabpanel" aria-labelledby="v-pills-nursery-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Nursery</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-playroom" role="tabpanel" aria-labelledby="v-pills-playroom-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Playroom</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-library" role="tabpanel" aria-labelledby="v-pills-library-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Library</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-storage-room" role="tabpanel" aria-labelledby="v-pills-storage-room-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Storage room</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-gym-room" role="tabpanel" aria-labelledby="v-pills-gym-room-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Gym room</p>
																</div>
															</div>
														</div>
														<div class="row">
												...
												<div class="tab-pane fade" id="v-pills-garage" role="tabpanel" aria-labelledby="v-pills-garage-tab">
													<div class="folder-wrapper">
														<div class="desktop-show">
															<div class="row mb-2">
																<div class="col-8">
																	<p class="folder-wrapper__heading">Title house name 1 - Garage</p>
																</div>
															</div>
														</div>
														<div class="row">
				...
				<div class="container-fluid">
							...
							<div class="first-footer__wrapper">
								<nav class="first-footer__wrapper--border js-show-all-footer-menu">
									...
									<ul class="first-footer__navivation">
										...
										<li><button title="See more..." class="first-footer__nav-show-button js-show-all-footer-menu-btn">See more...</button></li>
									</ul>
									<button title="Close" class="first-footer__nav-hide-button js-hide-all-footer-menu-btn">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g transform="translate(0 -0.001)"><g transform="translate(0 0.001)"><path d="M13.326,12l10.4-10.4A.938.938,0,0,0,22.4.275L12,10.675,1.6.275A.938.938,0,0,0,.274,1.6L10.674,12,.274,22.4A.938.938,0,0,0,1.6,23.726L12,13.327l10.4,10.4A.938.938,0,0,0,23.725,22.4Z" transform="translate(0 -0.001)"/></g></g></svg>
									</button>
					...
					<div class="row second-footer">
						<div class="col-12">
							<div class="second-footer__wrapper">
								<p class="second-footer__heading">Design your custom closet</p>
								<nav class="second-footer__navigation">
									<a href="#" title="Email A Closet Design">Email A Closet Design</a>
									<a href="#" title="Fax A Closet Design">Fax A Closet Design</a>
									<a href="#" title="Free Local In-Home Consultation">Free Local In-Home Consultation</a>
								</nav>
							</div>
						</div>
					</div>
					<div class="row third-footer">
						<div class="col-12 third-footer__wrapper">
							<p class="third-footer__heading">We proudly accept</p>
							...
							<div class="third-footer__social-media">
								<a href="#" title="Facebook"><img src="<?php echo SITEROOT; ?>images/facebook.svg" alt="Facebook"></a>
								<a href="#" title="Twitter"><img src="<?php echo SITEROOT; ?>images/twitter.svg" alt="Twitter"></a>
								<a href="#" title="LinkedIn"><img src="<?php echo SITEROOT; ?>images/linkedin.svg" alt="LinkedIn"></a>
								<a href="#" title="Houzz"><img src="<?php echo SITEROOT; ?>images/iconfinder_houzz.png" alt="Houzz"></a>
								<a href="#" title="Pinterest"><img src="<?php echo SITEROOT; ?>images/logotype.svg" alt="Pinterest"></a>
								<a href="#" title="Instagram"><img src="<?php echo SITEROOT; ?>images/brands-and-logotypes.svg" alt="Instagram"></a>
								<a href="#" title="Youtube"><img src="<?php echo SITEROOT; ?>images/brands-and-logotypes(1).svg" alt="Youtube"></a>
							</div>
			...
			<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<p class="modal-title" id="newFolderTitle">Folder title <span></span></p>
		...
		<div id="modal-manage-saved-houses"></div>
		...
		<div class="modal fade" id="deleteFolder" tabindex="-1" role="dialog" aria-labelledby="#deleteFolderTitle" aria-hidden="true">
			<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<p class="modal-title" id="newFolderTitle"><span>XXXX</span></p>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
		...
		<div id="modal-alert-confirmation"></div>
		...
		<div class="modal addEditFolder fade" id="newImageUrl" tabindex="-1" role="dialog" aria-labelledby="#newImageUrlTitle" aria-hidden="true">
			<div class="modal-dialog external-url modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<p class="modal-title" id="newImageUrlTitle"></p>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
