...
<html lang="en">
	...
	<meta name="description" content="We design survey"><link href="app.css" rel="stylesheet"></head>
	<body class="clearfix we-design-survey-page">
		...
		<main id="maincontent" class="main ">
			...
			<div>
				...
				<br>
				<!-- <div class="title wrapper text-center">Select the Closet System that best suites your budget & style <br /> Each added $ sign is associated with overall cost of closet</div> -->
        	<br>
				<form action="#" class="form block-with-background container-fluid wrapper">
					<!-- Progress bar -->
		...
		<div class="form-step form-step-active">					  
			<div class="box-content">
				...
				Your Closets To Go Team is standing by and eager to start creating the perfect space for your home! </p>
...
<input type="radio" name="Design" value="Design">
			...
			<div class="box-content">
				<div class="input-group">
					<div class="title wrapper text-center">Request a completion date for your project considering shipping estimates below.</div>
					<br />
				</div>				
				<p class="desc">
				...
				<div class="col-12 col-lg-12 company-block__images">
					<img class="map-delivery-desktop" src="../../images/map-delivery.png" alt="map" >
					<img class="map-delivery-mobile" src="../../images/map-mobile.png" alt="map" >
					<input type="date" id="date" name="date" style="width: 170px;">
				</div>
			...
			<div class="box-content">
				<div class="input-group">
					<div class="title wrapper text-center">Are you on a short timeline and need to expedite your order?</div>
					<br />
				</div>				
				<p class="desc">
				...
				<div class="input-group d-flex special-position">
					<div class="w80">
						<input type="text" name="order" id="оther" />
					</div>
				</div>	
				<span class="note">Note: Additional information can be noted in "Other"</span>
				  <br />
		...
		<div class="form-step">
			...
			<div class="box-content">
				<div class="input-group">
					...
					<p class="desc">NOTE: If seeking design for multiple closets, you will have an option at the end to add an additional closet design.</p>
					<br />
				</div>	
				...
				<div class="input-group d-flex special-position">
					<div class="w80">
						<input type="text" name="name-closet" id="оther" />
					</div>
				</div>	
			</div>
			...
			<div class="box-content" id="selectClosetType">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="radio" name="Closet Type" value="2" class="Walk-in-Closet">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="radio" name="Closet Type" value="2" class="Reach-in-Closet">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="radio" name="Closet Type" value="2" class="Kids-Closet">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="radio" name="Closet Type" value="2" class="kitchen-pantry">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="radio" name="Closet Type" value="2" class="Wine-Rack">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="radio" name="Closet Type" value="2" class="Hall">
			...
			<div class="box-content">
				...
				<div class="d-inline-block-step-three">
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								<input type="radio" name="Angle" value="2">
								<span>Standard Room</span>
							</label>
						</div>					
					</div>
					<div class="img-center">
						<img src="../../images/Standard.png" alt="standart room" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/Squared.png" alt="standart room" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/L-Shape-1.png" alt="L-Shape 1" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/L-Shape-2.png" alt="L-Shape 2" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/L-Shape-3.png" alt="L-Shape 3" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/L-Shape-4.png" alt="L-Shape 4" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/Angle-1.png" alt="Angle 2" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/Angle-2.png" alt="Angle 2" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/Angle-3.png" alt="Angle 3" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/Angle-4.png" alt="Angle 4" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/Angle-5.png" alt="Angle 5" >
					</div>
				</div>
				...
				<div class="d-inline-block-step-three">
					...
					<div class="img-center">
						<img src="../../images/Angle-6.png" alt="Angle 6" >
					</div>
				</div>

				<div class="input-group d-flex special-position">
					<div class="w80">
						<input type="text" name="shape" id="оther" />
					</div>
				</div>	
				<span class="note">Note: Additional information can be noted in "Other"</span>	
			</div>
			...
			<div class="box-content">
				<div class="input-group">
					<div class="title wrapper text-center">Wall Lengths </div>
					<p class="desc">Select the boxes associated with the walls in your space. Fill in all room dimensions including the return walls (A & F) </p>
					<br />
				</div>	

				<div class="img-center">
					<img src="../../images/wall-Lengths.jpg" alt="wall Lengths" class="img-walls" >
				</div>

				<div class="input-group d-flex special-position walls walls-a">
					<div class="w80">
						<span>A</span>
						<input type="text" name="a" id="оther" class="input-walls" />						
					</div>
				</div>

				<div class="input-group d-flex special-position walls walls-b">
					<div class="w80">
						<span>B</span>
						<input type="text" name="b" id="оther" class="input-walls" />						
					</div>
				</div>

				<div class="input-group d-flex special-position walls walls-c">
					<div class="w80">
						<span>C</span>
						<input type="text" name="c" id="оther" class="input-walls" />						
					</div>
				</div>

				<div class="input-group d-flex special-position walls walls-d">
					<div class="w80">
						<span>D</span>
						<input type="text" name="d" id="оther" class="input-walls" />						
					</div>
				</div>

				<div class="input-group d-flex special-position walls walls-e">
					<div class="w80">
						<span>E</span>
						<input type="text" name="e" id="оther" class="input-walls" />						
					</div>
				</div>

				<div class="input-group d-flex special-position walls walls-f">
					<div class="w80">
						<span>F</span>
						<input type="text" name="f" id="оther" class="input-walls" />						
					</div>
				</div>
				...
				<div class="input-group d-flex special-position">
					<div class="w80">
						<input type="text" name="оther" id="оther" />
					</div>
				</div>	
				<span class="note">Note: Additional information can be noted in "Other"</span>	
				<br />
			...
			<div class="box-content accessories-step-four">
				...
				<div class="d-inline-block">
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								<input type="checkbox" name="f12" value="2">
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/sloped.jpg" alt="sloped" >
								</div>
							</label>
						</div>					
					</div>					
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/bulk-head.jpg" alt="Bulk Headm">
								</div>
							</label>
						</div>					
					</div>					
			...
			<div class="box-content">
				...
				<div class="img-center">
					<img src="../../images/d1.jpg" alt="No Door" >
				</div>
				...
				<div class="img-center">
					<img src="../../images/d2.jpg" alt="Doors (Swings outward from the space)" >
				</div>
				...
				<div class="img-center">
					<img src="../../images/d3.jpg" alt="Door (Swings Inward to the Left)" >
				</div>
				...
				<div class="img-center">
					<img src="../../images/d4.jpg" alt="Door (Swings inward to the Right)" >
				</div>
				...
				<div class="img-center">
					<img src="../../images/d5.jpg" alt="Bi Fold" >
				</div>
				...
				<div class="img-center">
					<img src="../../images/d6.jpg" alt="Tri Fold" >
				</div>
				...
				<div class="img-center">
					<img src="../../images/d7.jpg" alt="Sliding" >
				</div>
				...
				<div class="input-group d-flex special-position">
					<div class="w80">
						<input type="text" name="walk" id="оther" />
					</div>
				</div>	
				<span class="note">Note: Additional information can be noted in "Other"</span>
				  <br />
			...
			<div class="box-content">
				<div class="input-group">
					<div class="title wrapper text-center">Select all obstructions we should be aware of when designing your custom closet.</div>
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-none" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-light" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-el" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-window" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-crawn" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-attic" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-vent" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-floor" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-safe" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-panel" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-hvac" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="r6-other" value="2">
							<span class="square">Other</span>
						</label>
					</div>
				</div>
				<div class="input-group d-flex special-position">
					<div class="w80">
						<input type="text" name="r6-other-text" id="оther" />
					</div>
				</div>	
				<span class="note">Note: Additional information can be noted in "Other"</span>
				  <br />
			...
			<!-- <div class="box-content">
				<div class="input-group">
					<div class="title wrapper text-center">Please reconfirm your Closet Type Category</div>
					<p class="desc">Closets examples are: Dressing Rooms, Kids Closets, Hall or Linen Closets, Home Office or Libraries, Hobby or Spare Rooms</p>
					<br />
				</div>						
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							...
							<span>Closet: Walk In, Reach In, Free Standing Armoire</span>
						</label>
					</div>
				</div>
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="radio" name="r7" value="2">
							<span>Convertible Wine Rack(s) or Wine cellar</span>
						</label>
					</div>
				</div>
				<br />
		...
		<div class="form-step step-four">
			...
			<div class="box-content">
				...
				<div class="mini-box">
					<div class="img-center">
						<img src="../../images/level4.jpg" for="" alt="Level 4" > 
					</div>
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
			...
			<div class="box-content">
				<div class="input-group">
					<div class="title wrapper text-center">How many feet across do you need for double hanging space? (shirts, jackets, pants, ect)</div>
					<p class="desc">Double hanging will maximize your storage needs & generally will work for majority of hanging needs.</p>
					<br />
				</div>				
				
				<div class="img-center">
					<img src="../../images/space-shared.jpg" alt="Shared space" > 
				</div>
			...
			<div class="box-content">
				...
				<div class="img-center">
					<img src="../../images/jake-make-rendering.jpg" alt="MAKE RENDERING" > 
				</div>
			...
			<div class="box-content">
				...
				<div class="img-center">
					<img src="../../images/drawers-new.jpg" alt="drawers" > 
				</div>
			...
			<div class="box-content"> 
				...
				<div class="d-inline-block">
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								<input type="checkbox" class="checkbox_check" name="q6" value="2">
								<span class="d-inline square">Flat Fronts (standard)</span><br />
								<div class="img-center">
									<img src="../../images/flat1.jpg" alt="Flat Fronts" > 
								</div>
							</label>
						</div>
					</div>					
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/flat2.jpg" alt="Shaker Fronts (upgrade)" > 
								</div>
							</label>
						</div>
					</div>					
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/flat3.jpg" alt="Glass Fronts" > 
								</div>
							</label>
						</div>
					</div>					
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q6" value="2">
							<span class="square">Select all that apply</span>
						</label>
					</div>
				</div>
			...
			<div class="box-content">
				...
				<div class="img-center">
					<img src="../../images/shelves.jpg" alt="How many shelves do you prefer" > 
				</div>
			...
			<div class="box-content">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q8-1" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q8-2" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q8-3" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q8-4" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q8-5" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q8-6" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q8-7" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q8-8" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="q8-9" value="2">
							<span class="square">Other</span>
						</label>
					</div>
				</div>
				<div class="input-group d-flex special-position">
					<div class="w80">
						<input type="text" name="q8-10" id="оther" />
					</div>
				</div>	
				<span class="note">Note: Additional information can be noted in "Other"</span>
				  <br />
			...
			<div class="box-content">
				...
				<div class="img-center">
					<img src="../../images/shoe-storage.jpg" alt="What shoe storage styles suite your shoe collection?" > 
				</div>
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="w1-1" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="w1-2" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="w1-3" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="w1-4" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="w1-5" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="w1-6" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="w1-7" value="2">
				...
				<div class="col-12 item">
					<div class="form-group mobile-order-search-form-group">	
						<label class="home-consult-form__radio">
							<input type="checkbox" name="w1-8" value="2">
							<span class="square">Other</span>
						</label>
					</div>
				</div>
				<div class="input-group d-flex special-position">
					<div class="w80">
						<input type="text" name="w1-9" id="оther" />
					</div>
				</div>	
				<span class="note">Note: Additional information can be noted in "Other"</span>
				  <br />
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/hamper.jpg" alt="Hamper" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/belt-racks.jpg" alt="Belt Racks" >
								</div>
							</label>
						</div>					
					</div>					
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/tie-rack.jpg" alt="Tie Rack" >
								</div>
							</label>
						</div>					
					</div>					
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/scarf-rack.jpg" alt="Scarf Rack" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/valet-rod.jpg" alt="Valet Rod" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/jewelry-tray.jpg" alt="Jewelry Tray" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/ironing-board.png" alt="Ironing Board" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/hook-strip.jpg" alt="Hooks or Hook Strip" >
								</div>
							</label>
						</div>					
					</div>					
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/hanging-rod.jpg" alt="Pull Down Hanging Rod" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/pants-rack.jpg" alt="Pull out pants rack" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/led-lights.jpg" alt="LED Strip Lights" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/puck-lighting.jpg" alt="Puck Lighting" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/crown-molding.jpg" alt="Crown-Molding" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/dove-tail-drawers.jpg" alt="Dove Tail Drawers" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/shoe-fences.jpg" alt="Shoe Fences" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/soft-close-slides.jpg" alt="Soft Close Slides" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/undermount-soft-close-slides.jpg" alt="Undermount Soft Close Slides" >
								</div>
							</label>
						</div>					
					</div>
		...
		<div class="form-step step-five ">
			...
			<div class="box-content">
				...
				<div class="mini-box">
					<div class="img-center">
						<img src="../../images/level1-2.jpg" alt="Level 1" >
					</div>
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<span class="level-simbol one">$</span>
				...
				<div class="mini-box">
					<div class="img-center">
						<img src="../../images/level2-2.jpg" alt="Level 2" >
					</div>
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<span class="level-simbol two">$$</span>
				...
				<div class="mini-box">
					<div class="img-center">
						<img src="../../images/level3-3.jpg" alt="Level 3" >
					</div>
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<span class="level-simbol three">$$$</span>
				...
				<div class="mini-box">
					<div class="img-center">
						<img src="../../images/level4-4.jpg" for="" alt="Level 4" > 
					</div>
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<span class="level-simbol four">$$$$</span>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/LED-Lighting.jpg" alt="LED-Lighting" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/door-front.jpg" alt="Door Front(s)" style="width: 136px;" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Drawer-s-new.jpg" alt="Drawer(s) (Items not visible when closed)" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Pull-Out-Shelf.jpg" alt="Pull Out Shelf or Shelves (items visible when closed)" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Pull-Out-Basket(s).jpg" alt="Pull Out Basket(s)" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Drawer-Dividers.jpg" alt="Drawer Dividers" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Pull-Out-Spice-Rack(s).jpg" alt="Pull Out Spice Rack(s)" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Sliding-Spice-Rack.jpg" alt="Sliding Spice Rack" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Vertical-Divider(s).jpg" alt="Vertical Divider(s) for baking sheets, trays, ect." >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/tilted.jpg" alt="Tilted Can Shelf or Shelves" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Wine-Cubbies.jpg" alt="Wine Cubbies" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Stemware-Rack.jpg" alt="Stemware Rack" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Revolving-Lazy-Suzen.jpg" alt="Revolving Lazy Suzen" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Pull-Out-Waste-Recycle-Baskets.jpg" alt="Pull Out Waste & Recycle Baskets" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/tall.jpg" alt="Tall, Enclosed Storage for brooms, mops, ect" style="width: 136px;" >
								</div>
							</label>
						</div>					
					</div>
		...
		<div class="form-step step-six">
			...
			<div class="box-content">
				...
				<div class="mini-box">
					<div class="img-center">
						<img src="../../images/v1.jpg" alt="Level 1" >
					</div>
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<span class="level-simbol one">$</span>
				...
				<div class="mini-box">
					<div class="img-center">
						<img src="../../images/v2.jpg" alt="Level 2" >
					</div>
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<span class="level-simbol two">$$</span>
				...
				<div class="mini-box">
					<div class="img-center">
						<img src="../../images/v3.jpg" alt="Level 3" >
					</div>
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<span class="level-simbol three">$$$</span>
				...
				<div class="mini-box">
					<div class="img-center">
						<img src="../../images/v4.jpg" for="" alt="Level 4" > 
					</div>
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<span class="level-simbol four">$$$$</span>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<span class="square d-inline">Stemware Rack</span>
								<div class="img-center">
									<img src="../../images/acc.jpg" alt="Stemware Rack" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<span class="square d-inline">Crown-Molding</span>
								<div class="img-center">
									<img src="../../images/Crown--Molding.jpg" alt="Crown-Molding" style="width: 310px;">
								</div>
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/LED-Lighting-new.jpg" alt="LED Lightings" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/arch.jpg" alt="Solid Oak Center Arch" style="width: 310px;">
								</div>
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Drop-Down-Table.jpg" alt="Drop Down Table" >
								</div>
							</label>
						</div>
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Pull-out-shelves.jpg" alt="Pull out shelves" >
								</div>
							</label>
						</div>
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Drawers-new3.jpg" alt="Drawers" >
								</div>
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Hemidor.jpg" alt="Hemidor" >
								</div>
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/Glass-Door-Fronts.jpg" alt="Glass-Door-Fronts" >
								</div>
							</label>
						</div>
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/finish_white.jpg" alt="Oxford White" >
								</div>
							</label>
						</div>					
					</div>
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/finish_antique_white.jpg" alt="Antique White">
								</div>
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/finish_almond.jpg" alt="Almond" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/custom-grey.jpg" alt="Custom Grey" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/negotiating-in-geneva.jpg" alt="Negotiating In Geneva" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/hardrock-maple.jpg" alt="Hardrock Maple" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/backwoods-sycamore.jpg" alt="Backwoods Sycamore" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/sunset-cherry.jpg" alt="Sunset Cherry" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/closets-to-go-rustik-cherry.jpg" alt="Alabama Cherry" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/rustic-alder.jpg" alt="Rustic Alder" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/american-black-walnut.jpg" alt="American Black Walnut" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/finish_chocolate_pear.jpg" alt="Chocolate Apple" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/windsor-mahogany.jpg" alt="Windsor Mahogany" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/african-mahogany.jpg" alt="African Mahogany" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-diva.jpg" alt="Diva" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-vanilla-stix.jpg" alt="Vanilla Stix" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-aria.jpg" alt="Aria" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-sandalwood.jpg" alt="Sandalwood" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-stromboli.jpg" alt="Stromboli" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-driftwood.jpg" alt="Driftwood" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-pewter-pine.jpg" alt="Pewter Pine" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-zambukka.jpg" alt="Zambukka" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-libretti.jpg" alt="Libretti" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-mochatini.jpg" alt="Mochatini" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-linear-ash.jpg" alt="Linear Ash" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-verismo.jpg" alt="Verismo" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/n-queenston-oak.jpg" alt="Queenston Oak" >
								</div>	
							</label>
						</div>
					</div>	
					...
					<div class="col-12 item">
						<div class="form-group mobile-order-search-form-group">	
							<label class="home-consult-form__radio">
								...
								<div class="img-center">
									<img src="../../images/finish_other.jpg" alt="Other" >
								</div>	
							</label>
						</div>
					</div>	
