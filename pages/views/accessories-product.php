...
?>
			...
			<div class="accordion accordion-organizer-landing-page showroom-details product-detail"
				...
				<div class="card">
					<div class="d-flex align-items-center pl-2">
						<a href="#" title="Arrow" class="d-flex align-items-center">
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item"><a href="accessory-category.html" title="Accessory Category">Accessory Category</a></li>
										<li class="breadcrumb-item"><a href="accessories.html" title="Accessory">Accessory</a></li>
										<li class="breadcrumb-item active" aria-current="page" title="Accessory detail">Accessory detail</li>
									</ul>
								</div>
							</div>
						</div>
									...
									<div class="row">
										<div class="col-12">
											<div class="product-detail__carousel image-gallery js-add-to-card-image-holder">
												<a href="https://www.youtube.com/embed/Wb0JINqX71w" title="Play Video"
									...
									<div class="row">
										<div class="col-12">
											<div class="back-to-filters-wrap">
												<a href="#" title="Back to filters" class="btn btn-primary pt-2 pb-2  ">
													back to filters
												</a>
											</div>
										</div>
									...
									<div class="col-12">
										...
										<div class="tab-content product-tab-content" id="pills-tabContent" data-target="pills-tabContent">
												...
												<div class="tab-content__specifications">
													...
													<div class="row">
														<div class="col-12 mobile-text-center">
															<a href="#" title="Download PDF" class="link-button mt-4 mb-0 margin_nd__a">
																download pdf
													...
													<div class="row row-padding__a-v2">
														<div class="col-12 js-specifications-subheading_v2">
															<p class="tab-content__specifications--subheading mobile-style">
																Description
											...
											<div class="tab-pane fade" id="pills-reviews" role="tabpanel"
												...
												<div>
													...
													<p class="mobile-text-center mt-2 mb-0">
														<a href="#" title="See more" class="product-tab-content__link">See
															more</a>
													</p>
												</div>
											</div>
											<div class="tab-pane fade" id="pills-Installations" role="tabpanel"
															...
															<div class="row">
																...
																<div class="col-12 col-lg-6">
																	<div class="product-dyi-installer__heading-button-wrap">
																		<button title="Download Instructions" class="product-dyi-installer__heading-button product-detail">
												...
												<p class="mobile-text-center mt-2 mb-0">
													<a href="#" title="Read more" class="product-tab-content__link">Read more</a>
												</p>
											</div>
										</div>
									</div>
									...
									<div class="col-12 five-elements-block__content">
										<div class="five-elements-block__wrapper services-caro">
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#" title="Closet Solutions: DIY Online Designs">
													<figure>
											...
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#" title="Custom Closets: Order Online Today">
													<figure>
														<div class="five-elements-block__wrapper--image">
											...
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#" title="Closet Design: Easy Online Design Tool">
													<figure>
														<div class="five-elements-block__wrapper--image">
											...
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#" title="Closet Systems: Designed By You, Crafted By Us">
													<figure>
														<div class="five-elements-block__wrapper--image">
											...
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#" title="loset Organizers: Custom-designed by you, quality-b...">
													<figure>
														<div class="five-elements-block__wrapper--image">
								...
								<div class="row mt-4">
									<div class="col-12 five-elements-block__content">
										<div class="five-elements-block__wrapper services-caro">
											...
											<div class="five-elements-block__wrapper--item mt-0">
												<a href="#" title="Closet Organizers: Custom-designed by you, quality-b...">
													<figure>
														<div class="five-elements-block__wrapper--image">
															<img src="./images/solution-5.png" alt="">
														</div>
									...
									<figure class="col-12 col-lg-6 col-xl-4">
										<div class="catalog-block__content">
											...
											<figcaption class="text-center">
												<p>Closet Solutions: DIY Online Designs</p>
												<a href="#" title="Shop now" class="link-button">
													Shop now
		...
		<div class="modal fade modal-save-to-specs-sheet" id="saveToSpecSheet" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
               <div class="modal-content">
                  <div class="modal-header">
                     <p class="modal-title" id="exampleModalLongTitle">Save to Specification sheet</p>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                           <g transform="translate(0 -0.001)">
                              <g transform="translate(0 0.001)">
                                 <path fill="#000" d="M13.326,12l10.4-10.4A.938.938,0,0,0,22.4.275L12,10.675,1.6.275A.938.938,0,0,0,.274,1.6L10.674,12,.274,22.4A.938.938,0,0,0,1.6,23.726L12,13.327l10.4,10.4A.938.938,0,0,0,23.725,22.4Z" transform="translate(0 -0.001)"></path>
                              </g>
                           </g>
                        </svg>
                     </button>
                     <button type="button" class="close-mobile" data-dismiss="modal" aria-label="Close">
                     <img src="./images/keyboard_arrow_left-24px-white.svg" alt="">
                     </button>
                  </div>
                  <p class="modal-sub-title">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut diam nonumy eirmod tempor invidunt.</p>
                  <div class="modal-body">
                     <div class="row">
                        <div class="col-lg-5">
                           <img class="item-selected" src="./images/popup-save-seet-thumnail.png" alt="">
                           <p class="modal-desctiption">Lorem ipsum dolor sit amet, consetetur nonumy eirmod tempor invidunt sit amet.</p>                           
                           <table class="table">
                              <tbody>
                                 <tr>
                                    <td>Color</td>
                                 ...
                                 <tr>
                                    <td>Size</td>
                                    <td>Facilisis, sodales sapien et non.</td>
                                 </tr>
                                 <tr>
                                    <td>Materials</td>
                                    <td>Pellenteaque habitant morbi</td>
                                 </tr>
                                 <tr>
                                    <td>Color</td>
                                    <td>Tristique senectus et netus et netus</td>
                                 </tr>
                                 <tr>
                                    <td>Size</td>
                                    <td>Facilisis, sodales sapien et non.</td>
                        ...
                        <div class="col-lg-7 right-side">
                           <div class="row">
                              <div class="col-12 js-specifications-subheading_v2 padding-no__a-v2">
                                 <p class="tab-content__specifications--subheading">
                                    Color
                                    <img class="tab-content__specifications--subheading-icon-plus" src="./images/minus-button-1.svg" alt="" style="display: none;">
                                    <img class="tab-content__specifications--subheading-icon-minus" src="./images/minus-button.svg" alt="" >
                                 </p>
                              </div>
                              <div class="col-12 popup-padding-no">
                                 <div class="phantom-actions__dropdowns__a popup-padding-row">
                                    ...
                                    <div class="phantom-actions__dropdowns accordion active nd"
                                       ...
                                       <div class="row margin-none sec-feature-one">
                                          ...
                                          <div class="col-2 feature-product__item-image drop_detail__items popup-save-sheet sec-one">
                                             <div class="feature-detail__item-drop"
                                                title="Simple name"
                                                data-container="#collapseFeature-parent-2"
                                                data-toggle="tooltip" data-container="body" data-placement="top" title="Simple name"
                                                ...
                                                <button class="feature-detail__item-drop__show-more hover-btn__v2 v3_a"
                                                   data-toggle="collapse"
                                                   data-target="#collapseFeature-12"
                                                   aria-expanded="true"
                                                   aria-controls="collapseFeature-12"
                                                   >
                                                   <svg xmlns="http://www.w3.org/2000/svg" width="3.726" height="6.536" viewBox="0 0 3.726 6.536">
                                                      <defs>
                                                         <style>.a{fill:#fff;}</style>
                                                      </defs>
                                                      <g transform="translate(0 6.536) rotate(-90)">
                                                         <path class="a" d="M3.268,3.726a.456.456,0,0,1-.324-.134L.134.781A.458.458,0,0,1,.781.134L3.268,2.621,5.755.134A.458.458,0,0,1,6.4.781L3.592,3.592A.456.456,0,0,1,3.268,3.726Z"/>
                                                      </g>
                                                   </svg>
                                                </button>
                                             </div>
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 popup-padding-no">
                                 <fieldset>
                                    <div class="phantom-actions__dropdowns__a popup-padding-row d-i-b">
                                       <div class="checkbox">
                              ...
                              <div class="col-12 popup-padding-no">
                                 <div class="phantom-actions__dropdowns__a popup-padding-row">
                                    <!--MENU WITH ADDITIONAL FEATURES,
                                       ...
                                       -->
                                    <div class="phantom-actions__dropdowns accordion active nd"
                                       id="collapseFeature-parent-22">
                                       <div class="row margin-none sec-feature-two">
                                          <div class="col-2 feature-product__item-image a__simple">
                                             <div class="feature-detail__item-drop"
                                                data-feature="feature-item"
                                                data-container="#collapseFeature-parent-22"				
                                                data-toggle="tooltip" data-placement="top" title="Simple name"																																				 
                                                >
                                                <img src="./images/lock_product-thumb.png" class="img-fluid selected-item-border" alt="">
                                                <span class="eye_top-right__selected">
                                                   <svg xmlns="http://www.w3.org/2000/svg" width="22.47" height="16.375" viewBox="0 0 27.47 16.375">
                                          ...
                                          <div class="col-2 feature-product__item-image drop_detail__items popup-save-sheet sec-two">
                                             <div class="feature-detail__item-drop"
                                                title="Simple name"
                                                data-container="#collapseFeature-parent-22"
                                                data-toggle="tooltip" data-container="body" data-placement="top" title="Simple name"
                              ...
                              <div class="col-12 popup-padding-no">
                                 <div class="phantom-actions__dropdowns__a popup-padding-row">
                                    <!--MENU WITH ADDITIONAL FEATURES,
                                       ...
                                       --> 
                                    <div class="phantom-actions__dropdowns accordion active nd"
                                       id="collapseFeature-parent-23">
                                       <div class="row margin-none sec-feature-three">
                                          <div class="col-2 feature-product__item-image a__simple">
                                             <div class="feature-detail__item-drop"
                                                data-feature="feature-item"
                                                data-container="#collapseFeature-parent-23"				
                                                data-toggle="tooltip" data-container="body" data-placement="top" title="Simple name"																																				 
                                                >
                                                <img src="./images/lock_product-thumb.png" class="img-fluid selected-item-border" alt="">
                                                <span class="eye_top-right__selected">
                                          ...
                                          <div class="col-2 feature-product__item-image drop_detail__items popup-save-sheet sec-three">
                                             <div class="feature-detail__item-drop"
                                                title="Simple name"
                                                data-container="#collapseFeature-parent-23"
                                                data-toggle="tooltip" data-container="body" data-placement="top" title="Simple name"
                                                ...
                                                <button class="feature-detail__item-drop__show-more hover-btn__v2 v3_a"
                                                   data-toggle="collapse"
                                                   data-target="#collapseFeature-14"
                                                   aria-expanded="true"
                                                   aria-controls="collapseFeature-14"
                                                   >
                                                   <svg xmlns="http://www.w3.org/2000/svg" width="3.726" height="6.536" viewBox="0 0 3.726 6.536">
                                                      <defs>
                                                         <style>.a{fill:#fff;}</style>
                                          ...
                                          <div
                                             id="collapseFeature-14" class="border-nd_hove_nd collapseFeature-opacity_class collapse show border-nd_hove_nd"
                                             aria-labelledby="headingOne"
                                             data-parent="#collapseFeature-parent-2"
                                             >
                                             <div class="row dropdown-items">
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 popup-padding-no">
                                 <fieldset>
                                    <div class="phantom-actions__dropdowns__a popup-padding-row d-i-b">
                                       <div class="checkbox">
                                          <input type="checkbox" class="check custom-checkbox js-add-product-filter" id="checkbox-41" value="value41">
                                       ...
                                       <div class="checkbox">
                                          <input type="checkbox" class="check custom-checkbox js-add-product-filter" id="checkbox-42" value="value42">
                                       ...
                                       <div class="checkbox">
                                          <input type="checkbox" class="check custom-checkbox js-add-product-filter" id="checkbox-43" value="value43">
                                    ...
                                    <div class="d-i-b margin__a">
                                       <div class="checkbox">
                                          <input type="checkbox" class="check custom-checkbox js-add-product-filter" id="checkbox-44" value="value44">
                                       ...
                                       <div class="checkbox">
                                          <input type="checkbox" class="check custom-checkbox js-add-product-filter" id="checkbox-45" value="value45">
                                          <label for="checkbox-45">
                                          <span class="checkbox-label__text">
                                          33*15*85cm
                                          </span>
                                          </label>
                              ...
                              <div class="col-12 popup-padding-no">
                                 <div class="phantom-actions__dropdowns__a popup-padding-row">
                                    <!--MENU WITH ADDITIONAL FEATURES,
                                       ...
                                       -->
                                    <div class="phantom-actions__dropdowns accordion active nd"
                                       id="collapseFeature-parent-24">
                                       <div class="row margin-none sec-feature-four">
                                          <div class="col-2 feature-product__item-image a__simple">
                                             <div class="feature-detail__item-drop"
                                                data-feature="feature-item"
                                                data-container="#collapseFeature-parent-24"				
                                                data-toggle="tooltip" data-container="body" data-placement="top" title="Simple name"																																				 
                                                >
                                                <img src="./images/lock_product-thumb.png" class="img-fluid selected-item-border" alt="">
                                                <span class="eye_top-right__selected">
                                          ...
                                          <div class="col-2 feature-product__item-image drop_detail__items popup-save-sheet sec-four">
                                             <div class="feature-detail__item-drop"
                                                title="Simple name"
                                                data-container="#collapseFeature-parent-24"
                                                data-toggle="tooltip" data-container="body" data-placement="top" title="Simple name"
                                                ...
                                                <button class="feature-detail__item-drop__show-more hover-btn__v2 v3_a"
                                                   data-toggle="collapse"
                                                   data-target="#collapseFeature-15"
                                                   aria-expanded="true"
                                                   aria-controls="collapseFeature-15"
                                                   >
                                                   <svg xmlns="http://www.w3.org/2000/svg" width="3.726" height="6.536" viewBox="0 0 3.726 6.536">
                                                      <defs>
                                                         <style>.a{fill:#fff;}</style>
                                          ...
                                          <div
                                             id="collapseFeature-15" class="border-nd_hove_nd collapseFeature-opacity_class collapse show border-nd_hove_nd"
                                             aria-labelledby="headingOne"
                                             data-parent="#collapseFeature-parent-2"
                                             >
                                             <div class="row dropdown-items">
                  ...
                  <div class="modal-footer">
                     <fieldset>
                        <div class="house dropdown dropdown__filter" style="min-width: 135px">
                           <label class="dropdown-label dropdown-label__filter" data-default-text="Choose house">Choose house</label><span class="arr"></span>
                           <div class="dropdown-list">
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-21" name="value" value="My house title 1">
                                 <label for="checkbox-21">
                                 <span class="checkbox-label__text">
                                 My house title 1
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-22" name="value" value="My house title 2">
                                 <label for="checkbox-22">
                                 <span class="checkbox-label__text">
                                 My house title 2
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-23" name="value" value="My house title 3">
                                 <label for="checkbox-23">
                                 <span class="checkbox-label__text">
                                 My house title 3
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-24" name="value" value="My house title 4">
                                 <label for="checkbox-24">
                                 <span class="checkbox-label__text">
                                 My house title 4
                                 </span>
                        ...
                        <div class="room dropdown dropdown__filter val" style="min-width: 135px">
                           <label class="dropdown-label dropdown-label__filter" data-default-text="Choose room">Choose room</label><span class="arr"></span>
                           <div class="dropdown-list">
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-21" name="value" value="Living Room">
                                 <label for="checkbox-21">
                                 <span class="checkbox-label__text">
                                 Living Room
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-22" name="value" value="Bedroom">
                                 <label for="checkbox-22">
                                 <span class="checkbox-label__text">
                                 Bedroom
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-23" name="value" value="Kitchen">
                                 <label for="checkbox-23">
                                 <span class="checkbox-label__text">
                                 Kitchen
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-24" name="value" value="Dining room">
                                 <label for="checkbox-24">
                                 <span class="checkbox-label__text">
                                 Dining room
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-24" name="value" value="Family room">
                                 <label for="checkbox-24">
                                 <span class="checkbox-label__text">
                                 Family room
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-24" name="value" value="Guest room">
                                 <label for="checkbox-24">
                                 <span class="checkbox-label__text">
                                 Guest room
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-24" name="value" value="Bathroom room">
                                 <label for="checkbox-24">
                                 <span class="checkbox-label__text">
                                 Bathroom room
                                 </span>
                              ...
                              <div class="checkbox">
                                 <input type="radio" class="custom-checkbox" id="checkbox-24" name="value" value="Home Office">
                                 <label for="checkbox-24">
                                 <span class="checkbox-label__text">
                                 Home Office
                                 </span>
                           ...
                           <form action="">
                              <fieldset>
                                 <input type="text" id="fname" placeholder="Give a spec sheet name" name="fname">
                              </fieldset>
                           </form>
		...
		<div class="modal fade modal-save-to-specs-sheet" id="saveToIdeaFolder" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
               <div class="modal-content">
                  <div class="modal-header">
                     <p class="modal-title" id="exampleModalLongTitle">Save to My Inspirations</p>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                           <g transform="translate(0 -0.001)">
                              <g transform="translate(0 0.001)">
                  ...
                  <fieldset>
                     <div class="modal-footer">
                        ...
                        <div class="room dropdown dropdown__filter val" style="min-width: 135px">
                           ...
                           <form action="">
                              <fieldset>
                                 <input type="text" id="fname" style="visibility: hidden;" placeholder="Give a spec sheet name" name="fname">
                              </fieldset>
                           </form>
                        <button type="button" class="confirm">CONFIRM</button>
                     </div>
		...
		<!-- Mobile show footer buttons -->
		<div id="mobile-show-footer-buttons"></div>
