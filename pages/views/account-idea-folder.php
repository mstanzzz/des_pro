...
<img src="<?php echo SITEROOT; ?>images/comingSoonImageGif.gif" alt="" >
	...
	<div class="account-block__general-info idea-folder">
		<div class="account-block__general-info--image idea-folder-img">
			<p class="desktop-show">My Inspirations</p>
			<?php echo $svg_id_Component_18_1; ?>
			<div class="account-block__general-info--details mobile-show">
				<div class="row">
					<div class="col-12"><p>My Inspirations</p></div>
				</div>
				<div class="row">
					<div class="col-12"><p class="second-text"><?php echo $_SESSION['first_name']; ?></p></div>
			</div>
			<div class="row">
				<div class="col-12"><p class="second-text">admin@admincloset.togo</p></div>
			</div>
		</div>
		<?php echo $svg_info_mobil; ?>		  
	</div>
...
<div class="video-content desktop-show">
<div class="desc-box">
<div class="title">How to use the "My Inspirations folder"?</div>
<div class="description">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor</div>	
</div>
<div class="video-block">
<a href="https://www.youtube.com/embed/Wb0JINqX71w">
<img src="<?php echo SITEROOT; ?>images/video-bg.png" alt="" class="bg">
<p class="title">My Inspirations folder</p>
<p class="sub-title">WATCH<br /> VIDEO TUTORIAL</p>
<?php echo $svg_id_play; ?>
</a>										
</div>
</div>
<!-- My houses block -->
<div class="account-block__details idea-folder active" id="my-houses">
<p class="h1-nd-acc-idea-folder">MY SAVED PROPERTY</p>
<div class="row">
...
<img src="<?php echo SITEROOT; ?>images/my-house-1.png" alt="" class="img-fluid my-house__img--img">
...
<div class="my-house__img--group">
<img src="<?php echo SITEROOT; ?>images/my-house-2.png" alt="" class="img-fluid my-house__img--img">
...
<div class="my-house__img--group">
<img src="<?php echo SITEROOT; ?>images/my-house-3.png" alt="" class="img-fluid my-house__img--img">
...
<div id="video-tutorial-mobile">
<p class="modal-title">Welcome to Inspiration folder</p>
...
<div class="video-block">
<a href="https://www.youtube.com/embed/Wb0JINqX71w">
<img src="<?php echo SITEROOT; ?>images/vtm.png" alt="" class="bg">
</a>										
</div>
<div class="desc-box">
<div class="title">How to use the "My Inspirations folder"?</div>
