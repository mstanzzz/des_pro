...
<html lang="en">
	...
	<meta name="description" content="solution detail view"><link href="<?php echo SITEROOT; ?>app.css" rel="stylesheet"></head>
...
?>
		...
		<section class="first-fixed-block covid-block clearfix">
			<figure class="first-fixed-block__img-group" style="background-image: url('<?php echo SITEROOT; ?>images/solution-detail-view-header.png');">
		...
		<main class="main clearfix">
			...
			<section class="breadcrumb-block pt-5">
				<div class="wrapper">
							...
							<div class="col-12">
								<div class="breadcrumb-block__wrapper" aria-label="breadcrumb">
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item"><a href="#" title="Custom closet organizers for wardrobes">Custom closet organizers for
											wardrobes</a></li>
					...
					<div class="solution-block-carousel__wrapper">
						<div class="solution-block-carousel__wrapper--image-block">
							...
							<div class="image-share-buttons">
								...
								<button title="Share" class="share-img" data-img-path="images/solution-carousel-img-1.png">
						...
						<div class="row">
							<div class="col-12 col-xl-7">
								<div class="two-elements-block__wrapper">
									...
									<div class="two-elements-block__wrapper--link-block">
										<button title="Discover all" data-readAll="Discover all" data-readLess="Discover less" class="link-button js-btn-view-all-text">
								...
								<div class="two-elements-block__wrapper">
									<div class="two-elements-block__wrapper--content">
										...
										<div class="two-elements-block__wrapper--video">
											<p class="heading">Watch Our Installation Video</p>
							...
							<div class="col-12">
								<div class="two-elements-block__wrapper--stars">
									...
									<a href="#" title="Discover all" class="link-button">Discover all
										<svg xmlns="http://www.w3.org/2000/svg" width="20.8" height="14.623" viewBox="0 0 20.8 14.623">
											<path id="left-arrow_3_" data-name="left-arrow(3)"
													d="M14.014,4.9a.737.737,0,1,0-1.048,1.038l5.314,5.314H.744A.738.738,0,0,0,0,11.982a.747.747,0,0,0,.744.744H18.281l-5.314,5.3a.752.752,0,0,0,0,1.048.734.734,0,0,0,1.048,0l6.573-6.573a.739.739,0,0,0,0-1.038Z"
													transform="translate(0.001 -4.676)"/>
